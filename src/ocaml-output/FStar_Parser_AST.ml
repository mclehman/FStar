          ...
          let uu____3830 =
            FStar_List.choose
              (fun uu___73_3835  ->
                 ...
                 | uu____3839 -> FStar_Pervasives_Native.None) decorations
             in
          ...
          let uu____3845 =
            FStar_List.choose
              (fun uu___74_3854  ->
                 ...
                 | uu____3864 -> FStar_Pervasives_Native.None) decorations
             in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___75_3879  ->
               ...
               | uu____3883 -> FStar_Pervasives_Native.None) decorations
           in
      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____3951 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
                           ...
                           let phi1 =
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____5064)
                                in
                             mk_term
          ...
          to_string_l " and "
            (fun uu____5564  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____5571 uu____5572) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____5661 =
                     ...
                     | FStar_Pervasives_Native.Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____5663
                      in
          ...
          to_string_l "; "
            (fun uu____5930  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____5937) l
           in
        ...
        let uu____6176 =
          let uu____6177 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____6199  ->
                    match uu____6199 with | (x,uu____6207) -> id_of_tycon x))
             in
