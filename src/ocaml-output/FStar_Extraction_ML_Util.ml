    ...
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Var x ->
          let uu____112 =
            FStar_Util.find_opt
              (fun uu____126  ->
                 match uu____126 with | (y,uu____132) -> y = x) subst1
             in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,f,t2) ->
          let uu____149 =
            ...
            let uu____157 = subst_aux subst1 t2  in (uu____156, f, uu____157)
             in
                ...
                | uu____435 ->
                    ...
                    let uu____474 =
                      (mk_ty_fun ()) xs body.FStar_Extraction_ML_Syntax.mlty
                       in
                    FStar_Extraction_ML_Syntax.with_ty uu____474 e1
                 in
              (match e with
                               ...
                               let uu____542 =
                                 let uu____545 =
                                   (mk_ty_fun ()) [x]
                                    ...
                                    in
                                 FStar_Extraction_ML_Syntax.with_ty uu____545
                                  in
...
let argTypes :
  ...
  =
  fun t  ->
    let uu____1346 = doms_and_cod t  in
    FStar_Pervasives_Native.fst uu____1346
...
let mk_tactic_unembedding :
  ...
  fun args  ->
    ...
    let reify_tactic =
      ...
      FStar_All.pipe_left
        (FStar_Extraction_ML_Syntax.with_ty
           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1485
       in
    let from_tac =
      let uu____1501 =
        let uu____1502 =
      ...
      let uu____1504 =
        let uu____1505 =
          FStar_Util.string_of_int
            ((FStar_List.length args) - (Prims.parse_int "1"))
           in
        Prims.strcat "FStar_Tactics_Interpreter.unembed_tactic_" uu____1505
         in
    ...
    let app =
      ...
      | n1 ->
          ((let uu____1538 =
              let uu____1539 =
                let uu____1542 = FStar_Util.string_of_int n1  in [uu____1542]
                 in
              FStar_Util.format
...
let rec mk_tac_param_type :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1580 = FStar_Reflection_Data.fstar_refl_types_lid "binder"
           in
        FStar_Syntax_Syntax.fv_eq_lid fv uu____1580 ->
        fstar_refl_data_prefix "t_binder"
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1582 = FStar_Reflection_Data.fstar_refl_types_lid "term"
           in
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1586 = FStar_Reflection_Data.fstar_refl_syntax_lid "binder"
           in
         ...
         | FStar_Syntax_Syntax.Tm_uinst (h',uu____1616) ->
             ...
             (match uu____1621 with
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1644 =
                    let uu____1651 =
                      ...
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1652
                       in
                    let uu____1653 =
                      let uu____1656 =
                      ...
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1656
                       in
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1681 =
                    let uu____1688 =
                      let uu____1689 = fstar_tc_common_prefix "t_option_of"
                         in
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1689
                       in
                    let uu____1690 =
                      let uu____1693 =
...
let rec mk_tac_embedding_path :
  ...
  fun m  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1730 = FStar_Reflection_Data.fstar_refl_types_lid "term"
             in
          FStar_Syntax_Syntax.fv_eq_lid fv uu____1730 ->
          mk_embedding m "term"
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1732 = FStar_Reflection_Data.fstar_refl_types_lid "fv"
             in
           ...
           | FStar_Syntax_Syntax.Tm_uinst (h',uu____1764) ->
               let uu____1769 =
                 ...
                 | uu____1872 ->
                     ((let uu____1874 =
                         let uu____1875 =
                           let uu____1876 = FStar_Syntax_Subst.compress h'
                              in
                    ...
                    then
                      ...
                      (let uu____1902 =
                         let uu____1909 =
                           ...
                           FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top uu____1910
                            in
                         let uu____1911 =
                           FStar_List.map
                             (FStar_Extraction_ML_Syntax.with_ty
          ...
          try
            ...
            let tac_fun =
              let uu____2009 =
                ...
                let uu____2025 =
                  let uu____2028 = lid_to_top_name tac_lid  in [uu____2028]
                   in
            ...
            let args =
              let uu____2045 =
                let uu____2048 =
                  FStar_List.map (mk_tac_embedding_path Unembed) arg_types
                   in
                let uu____2051 =
                  ...
                  let uu____2055 =
                    ...
                    let uu____2059 =
                      let uu____2062 =
                        let uu____2065 = str_to_name "args"  in [uu____2065]
                         in
            ...
            let app =
              ...
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2067
               in
            FStar_Pervasives_Native.Some
              (FStar_Extraction_ML_Syntax.MLE_Fun
