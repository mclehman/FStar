    ...
    fun s  ->
      ...
      | FStar_Pervasives_Native.Some r ->
          let uu____1001 =
            ...
            FStar_Range.set_use_range (FStar_Ident.range_of_lid l) uu____1002
             in
  ...
  fun s  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
          let uu____3180 =
            let uu____3181 = let uu____3188 = subst' s t1  in (uu____3188, m)
               in
  ...
  fun bs  ->
    let rec aux bs1 o =
      ...
      | (x,imp)::bs' ->
          ...
          (match uu____3577 with | (bs'1,o2) -> (((x', imp) :: bs'1), o2))
       in
    aux bs []
         ...
         | (p1,opening) ->
             let wopt1 =
               ...
               | FStar_Pervasives_Native.Some w ->
                   ...
                   FStar_Pervasives_Native.Some uu____4508
                in
      ...
      | (x,imp)::tl1 ->
          ...
          let s' =
            ...
            (FStar_Syntax_Syntax.NM (x1, (Prims.parse_int "0"))) ::
              uu____4590
             in
          let uu____4593 = aux s' tl1  in (x1, imp) :: uu____4593
       in
    aux [] bs
