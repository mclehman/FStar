        ...
        fun original_map  ->
          fun filename  ->
            ...
            let add_dep d =
              ...
              then
                let uu____889 =
                  let uu____892 = FStar_ST.op_Bang deps  in d :: uu____892
                   in
            ...
            let record_open_module_or_namespace uu____1143 =
              ...
              | (lid,kind) ->
                  (match kind with
                   ...
                   | Open_module  ->
                       let uu____1150 = record_open_module false lid  in ())
               in
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____1369 =
                         ...
                         enter_namespace original_map working_map uu____1370
                          in
                       ())
                    else ();
                           ...
                           (fun uu____1478  ->
                              ...
                              | (m,r) ->
                                  let uu____1767 =
                                    ...
                                    (FStar_String.lowercase m) = uu____1768
                                     in
                                  if uu____1767
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____1922 =
                         ...
                         enter_namespace original_map working_map uu____1923
                          in
                       ())
                    else ();
                    (match verify_mode with
                           ...
                           (fun uu____2031  ->
                              ...
                              | (m,r) ->
                                  let uu____2320 =
                                    ...
                                    (FStar_String.lowercase m) = uu____2321
                                     in
                                  if uu____2320
                                  then FStar_ST.op_Colon_Equals r true
                                  else ()) verify_flags);
             ...
             and collect_decl uu___84_2473 =
               ...
               | FStar_Parser_AST.Tycon (uu____2526,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____2556  ->
                          match uu____2556 with | (x,docnik) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____3800 = lowercase_module_name f1  in
                     uu____3800 = m1) && (is_implementation f1)) filenames
                in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____4166
          in
