...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____1230 =
          let uu____1235 =
            let uu____1236 = FStar_Syntax_Syntax.mk_binder x  in [uu____1236]
             in
                               ...
                               let uu____1968 =
                                 let uu____1975 =
                                   let uu____1978 =
                                     ...
                                     [uu____1981]  in
                                   e1 :: uu____1978  in
                                 ((FStar_Ident.id_of_text "*"), uu____1975)
                                  in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | uu____2307 ->
                     ...
                     in
                  let body1 =
                    let uu____2309 = decomp body  in resugar_term uu____2309
                     in
                  let handler1 =
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____2948  ->
                       match uu____2948 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_44 when
                  ...
                  let uu____3041 =
                    let uu____3042 =
                      let uu____3049 =
                        let uu____3052 = last_two args1  in
                        resugar uu____3052  in
                      (op1, uu____3049)  in
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | FStar_Pervasives_Native.Some e1 ->
                    ...
                    FStar_Pervasives_Native.Some uu____3359
                 in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____3420) ->
        ...
        let uu____3487 =
          let uu____3488 =
            let uu____3497 = resugar_term e  in (uu____3497, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____3546 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____3551
                  in
                              ...
                              (match uu____3697 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____3711 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____4379, FStar_Parser_AST.UnivApp)) universes
                      in
                   let args1 =
                     FStar_List.map
                       (fun uu____4402  ->
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4515 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4552 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____5091  ->
                 ...
                 | (e,uu____5101) ->
                     ...
                     (uu____5102, FStar_Parser_AST.Nothing)) args
             in
  ...
  fun p  ->
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ({ FStar_Syntax_Syntax.fv_name = uu____5443;
             FStar_Syntax_Syntax.fv_delta = uu____5444;
          ...
          let fields1 =
            let uu____5471 =
              FStar_All.pipe_right fields
               ...
               in
            FStar_All.pipe_right uu____5471 FStar_List.rev  in
          let args1 =
            let uu____5487 =
              FStar_All.pipe_right args
               ...
               in
            FStar_All.pipe_right uu____5487 FStar_List.rev  in
          let rec map21 l1 l2 =
            match (l1, l2) with
            | ([],[]) -> []
            | ([],hd1::tl1) -> []
            | (hd1::tl1,[]) ->
                let uu____5577 = map21 tl1 []  in
                (hd1, (mk1 FStar_Parser_AST.PatWild)) :: uu____5577
            | (hd1::tl1,hd2::tl2) ->
                let uu____5600 = map21 tl1 tl2  in (hd1, hd2) :: uu____5600
             in
          let args2 =
            let uu____5618 = map21 fields1 args1  in
            FStar_All.pipe_right uu____5618 FStar_List.rev  in
      ...
      | FStar_Syntax_Syntax.Pat_var v1 ->
          ...
          (match uu____5679 with
           | FStar_Pervasives_Native.Some (op,uu____5687) ->
               mk1
           ...
           | FStar_Pervasives_Native.None  ->
               let uu____5696 =
                 let uu____5697 =
                   let uu____5704 = bv_as_unique_ident v1  in
                   let uu____5705 = to_arg_qual imp_opt  in
                   (uu____5704, uu____5705)  in
                 FStar_Parser_AST.PatVar uu____5697  in
               mk1 uu____5696)
      | FStar_Syntax_Syntax.Pat_wild uu____5710 ->
          mk1 FStar_Parser_AST.PatWild
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____5718 =
              let uu____5719 =
                let uu____5726 = bv_as_unique_ident bv  in
                (uu____5726,
                  (FStar_Pervasives_Native.Some FStar_Parser_AST.Implicit))
                 in
              FStar_Parser_AST.PatVar uu____5719  in
            mk1 uu____5718  in
          let uu____5729 = FStar_Options.print_bound_var_types ()  in
          if uu____5729
          then
            let uu____5730 =
              let uu____5731 =
                let uu____5736 = resugar_term term  in (pat, uu____5736)  in
              FStar_Parser_AST.PatAscribed uu____5731  in
            mk1 uu____5730
          else pat
       in
...
let resugar_qualifier :
  ...
  fun uu___194_5743  ->
    ...
    | FStar_Syntax_Syntax.Reflectable uu____5752 ->
        FStar_Pervasives_Native.Some FStar_Parser_AST.Reflectable
    | FStar_Syntax_Syntax.Discriminator uu____5753 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Projector uu____5754 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordType uu____5759 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordConstructor uu____5768 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Action uu____5777 -> FStar_Pervasives_Native.None
  ...
  fun datacon_ses  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          (tylid,uvs,bs,t,uu____5810,datacons) ->
          let uu____5820 =
              ...
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | FStar_Syntax_Syntax.Sig_datacon
                        (uu____5847,uu____5848,uu____5849,inductive_lid,uu____5851,uu____5852)
                        -> FStar_Ident.lid_equals inductive_lid tylid
                    | uu____5857 -> failwith "unexpected"))
             in
          (match uu____5820 with
           | (current_datacons,other_datacons) ->
               let bs1 =
                 let uu____5876 = FStar_Options.print_implicits ()  in
                 if uu____5876 then bs else filter_imp bs  in
               let bs2 =
               ...
               let tyc =
                 let uu____5886 =
                   FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                     (FStar_Util.for_some
                        (fun uu___196_5891  ->
                           match uu___196_5891 with
                           | FStar_Syntax_Syntax.RecordType uu____5892 ->
                               true
                           | uu____5901 -> false))
                    in
                 if uu____5886
                 then
                   let resugar_datacon_as_fields fields se1 =
                     match se1.FStar_Syntax_Syntax.sigel with
                     | FStar_Syntax_Syntax.Sig_datacon
                         (uu____5949,univs1,term,uu____5952,num,uu____5954)
                         ->
                         let uu____5959 =
                           let uu____5960 = FStar_Syntax_Subst.compress term
                              in
                           uu____5960.FStar_Syntax_Syntax.n  in
                         (match uu____5959 with
                          | FStar_Syntax_Syntax.Tm_arrow (bs3,uu____5974) ->
                              let mfields =
                          ...
                          | uu____6063 -> failwith "unexpected")
                     | uu____6074 -> failwith "unexpected"  in
                   let fields =
                   ...
                   (let resugar_datacon constructors se1 =
                      match se1.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_datacon
                          (l,univs1,term,uu____6195,num,uu____6197) ->
                          let c =
                            let uu____6215 =
                              let uu____6218 = resugar_term term  in
                              FStar_Pervasives_Native.Some uu____6218  in
                            ((l.FStar_Ident.ident), uu____6215,
                              FStar_Pervasives_Native.None, false)
                             in
                          c :: constructors
                      | uu____6235 -> failwith "unexpected"  in
                    let constructors =
...
let mk_decl :
  ...
  fun r  ->
    fun q  ->
      fun d'  ->
        let uu____6332 = FStar_List.choose resugar_qualifier q  in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = FStar_Pervasives_Native.None;
          FStar_Parser_AST.quals = uu____6332;
            ...
            let uu____6358 =
              let uu____6371 =
                let uu____6380 =
                  let uu____6387 =
                    let uu____6388 =
                      let uu____6401 = resugar_term typ  in
                      (name1, [], FStar_Pervasives_Native.None, uu____6401)
                       in
                    FStar_Parser_AST.TyconAbbrev uu____6388  in
                  (uu____6387, FStar_Pervasives_Native.None)  in
                [uu____6380]  in
              (false, uu____6371)  in
            FStar_Parser_AST.Tycon uu____6358  in
          mk_decl typ.FStar_Syntax_Syntax.pos [] uu____6357
        ...
        fun ed  ->
          let resugar_action d for_free1 =
            ...
            | (bs,action_defn) ->
                ...
                (match uu____6467 with
                 | (bs1,action_typ) ->
                     let action_params1 =
                       let uu____6475 = FStar_Options.print_implicits ()  in
                       if uu____6475
                       then action_params
                     ...
                     let action_params2 =
                       let uu____6480 =
                         FStar_All.pipe_right action_params1
                          ...
                          in
                       FStar_All.pipe_right uu____6480 FStar_List.rev  in
                       ...
                       let a =
                         let uu____6494 =
                           ...
                           (uu____6505,
                            ...
                            in
                         FStar_Parser_AST.Construct uu____6494  in
                       let t =
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6587 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6592 =
                  FStar_All.pipe_right eff_binders1
                    (map_opt (fun b  -> resugar_binder b r))
                   in
                FStar_All.pipe_right uu____6592 FStar_List.rev  in
                       ...
                       let uu____7106 =
                         let uu____7107 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7120)
                            in
          ...
          (let t' =
             let uu____7167 =
               (let uu____7170 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7170) || (FStar_List.isEmpty uvs)
                in
             if uu____7167
             then resugar_term t
             else
