      ...
      let rec revert_many st1 uu___238_2099 =
        ...
        | (task,_st')::entries ->
            ((let uu____2124 = Obj.magic ()  in ());
             ...
             (let uu____2126 = pop_repl st1  in
              revert_many uu____2126 entries))
         in
  ...
  fun key  ->
    fun a  ->
      let uu____2996 =
        FStar_Util.try_find
          (fun uu____3010  ->
             match uu____3010 with | (k,uu____3016) -> k = key) a
         in
    ...
    try
      ...
      let uu____3124 =
        ...
        | "lookup" ->
            let uu____3156 =
              ...
              let uu____3171 =
                ...
                FStar_All.pipe_right uu____3172 js_optional_lookup_context
                 in
              let uu____3177 =
                let uu____3186 =
                ...
                FStar_All.pipe_right uu____3186
                  (FStar_Util.map_option
                     (fun loc  ->
                        let uu____3253 =
                          let uu____3254 = assoc1 "[location]" "filename" loc
                             in
                        ...
                        let uu____3257 =
                          let uu____3258 = assoc1 "[location]" "column" loc
                             in
                          FStar_All.pipe_right uu____3258 js_int  in
                        (uu____3253, uu____3255, uu____3257)))
                 in
              let uu____3259 =
        ...
        | "vfs-add" ->
            ...
            VfsAdd uu____3308
        | uu____3329 ->
            let uu____3330 = FStar_Util.format1 "Unknown query '%s'" query
               in
            ProtocolViolation uu____3330
         in
      { qq = uu____3124; qid }
              ...
              let uu____3509 =
                let uu____3512 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____3518 = json_of_use_range r  in [uu____3518]
                   in
                let uu____3519 =
                  match issue.FStar_Errors.issue_range with
  ...
  fun lr  ->
    let uu____3686 =
      ...
      let uu____3699 =
        let uu____3706 =
          let uu____3711 =
            json_of_opt (fun _0_43  -> FStar_Util.JsonStr _0_43) lr.slr_typ
             in
          ("type", uu____3711)  in
        let uu____3712 =
          let uu____3719 =
            let uu____3724 =
              json_of_opt (fun _0_44  -> FStar_Util.JsonStr _0_44) lr.slr_doc
               in
  ...
  let js_features =
    let uu____3770 =
      FStar_List.map (fun _0_46  -> FStar_Util.JsonStr _0_46)
       ...
       in
    FStar_All.pipe_left (fun _0_47  -> FStar_Util.JsonList _0_47) uu____3770
     in
                ...
                FStar_All.pipe_right uu____4336
                  (FStar_Util.map_option
                     (fun default_value  ->
                        ...
                        let uu____4349 = snippets_of_fstar_option name typ
                           in
                        let uu____4352 =
                          ...
                          then OptSet
                            ...
                            (let uu____4355 = FStar_Options.resettable name
                                in
                             if uu____4355 then OptReset else OptReadOnly)
                           in
                        {
                          opt_name = name;
                          opt_sig = uu____4348;
  ...
  fun st  ->
    let uu____4829 =
      with_captured_errors st.repl_env
        (fun _env  ->
           let uu____4851 = deps_and_repl_ld_tasks_of_our_file st.repl_fname
              in
           FStar_All.pipe_left
             (fun _0_51  -> FStar_Pervasives_Native.Some _0_51) uu____4851)
       in
      ...
      | { push_kind; push_code = text1; push_line = line;
          ...
          (FStar_TypeChecker_Env.toggle_id_info st.repl_env true;
           (let frag =
            ...
            let uu____5012 =
              run_repl_transaction st push_kind peek_only (PushFragment frag)
               in
    ...
    fun deps  ->
      fun table  ->
        ...
        let loaded_mods_set =
          ...
          let uu____5091 =
            let uu____5094 = FStar_Options.prims ()  in uu____5094 :: deps
             in
          FStar_List.fold_left
            (fun acc  ->
               fun dep1  ->
                 let uu____5104 = FStar_Parser_Dep.lowercase_module_name dep1
                    in
    ...
    fun query  ->
      ...
      (let uu____5169 = load_deps st  in
       ...
       | FStar_Util.Inl (st1,deps) ->
           ((let uu____5233 = FStar_Options.restore_cmd_line_options false
                in
      ...
      fun pos_opt  ->
        fun requested_info  ->
          ...
          let info_of_lid_str lid_str =
            ...
            let uu____5355 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1
               in
            FStar_All.pipe_right uu____5355
              (FStar_Util.map_option
                 (fun uu____5410  ->
                    match uu____5410 with
                    | ((uu____5429,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
             in
          let docs_of_lid lid =
            let uu____5446 =
...
let run_code_lookup :
  ...
  fun st  ->
    fun symbol  ->
      fun pos_opt  ->
        fun requested_info  ->
          let uu____6203 = run_symbol_lookup st symbol pos_opt requested_info
             in
  ...
  fun st  ->
    fun term  ->
      fun rules  ->
        ...
        let parse1 frag =
          let uu____7103 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag)
             in
        ...
        let desugar env decls =
          let uu____7204 =
            let uu____7209 = FStar_ToSyntax_ToSyntax.decls_to_sigelts decls
               in
                 ...
                 (match uu____7275 with
                  ...
                  | FStar_Pervasives_Native.Some decls ->
                      let aux uu____7298 =
                        ...
                        | FStar_Pervasives_Native.Some (univs1,def) ->
                            let uu____7333 =
                              FStar_Syntax_Subst.open_univ_vars univs1 def
                               in
                      ...
                      then aux ()
                        ...
                        (try aux ()
                         ...
                         | e ->
                             let uu____7373 =
                               let uu____7374 = FStar_Errors.issue_of_exn e
                                  in
...
let json_of_search_result :
  ...
  fun tcenv  ->
    fun sc  ->
      let typ_str =
        let uu____7956 = sc_typ tcenv sc  in term_to_string tcenv uu____7956
         in
      let uu____7957 =
        let uu____7964 =
          let uu____7969 =
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____8042
           in
...
let interactive_mode : Prims.string -> Prims.unit =
  fun filename  ->
    ...
    (let uu____8726 =
       let uu____8727 = FStar_Options.verify_module ()  in uu____8727 <> []
        in
     if uu____8726
