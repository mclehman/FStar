    ...
    fun h1  ->
      fun h2  ->
        ...
        | (Heap (v1,hh1),Heap (v2,hh2)) ->
            let uu____185 =
              let uu____186 = cmp v1 v2  in uu____186 < (Prims.parse_int "0")
               in
            if uu____185
            then Heap (v1, (h2 :: hh1))
            else Heap (v2, (h1 :: hh2))
      ...
      let cmp v1 v2 =
        ...
        | ((pr1,h1::uu____652),(pr2,h2::uu____655)) ->
            let cmp_h =
              ...
              let uu____678 = key_fn h2  in
              string_compare uu____677 uu____678  in
    ...
    fun ns  ->
      let uu____2182 =
        ...
        | (ImportedNames (uu____2247,names2))::more_names ->
            ...
            (uu____2264, (FStar_Pervasives_Native.Some more_names))
         in
        ...
        (fun tr1  ->
           fun uu____2801  ->
             fun uu____2802  ->
               fun uu____2803  ->
                 fun namespaces  ->
                   let uu___169_2812 = tr1  in
                   { bindings = (uu___169_2812.bindings); namespaces })
      ...
      fun id  ->
        fun v1  ->
          trie_mutate_leaf tr ns_query
            (fun tr1  ->
               fun uu____2855  ->
                 let uu___170_2858 = tr1  in
                 let uu____2861 = names_insert tr1.bindings id v1  in
                 {
                   bindings = uu____2861;
                   namespaces = (uu___170_2858.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___171_2981 = tr1  in
                 {
                   bindings = ((ImportedNames (label, (inc.bindings))) ::
                     (tr1.bindings));
                   namespaces = (uu___171_2981.namespaces)
                 })
      ...
      fun included_query  ->
        trie_import tr host_query included_query
          (fun tr1  ->
             fun inc  ->
               fun label  ->
                 let uu___172_3026 = tr1  in
                 {
                   bindings = (uu___172_3026.bindings);
...
let insert : table -> query -> Prims.string -> lid_symbol -> table =
  fun tbl  ->
    fun host_query  ->
      fun id  ->
        fun c  ->
          let uu___173_3947 = tbl  in
          let uu____3948 = trie_insert tbl.tbl_lids host_query id c  in
          { tbl_lids = uu____3948; tbl_mods = (uu___173_3947.tbl_mods) }
      ...
      fun host_query  ->
        fun included_query  ->
          ...
          then register_include tbl host_query included_query
            ...
            (let uu___176_4004 = tbl  in
             let uu____4005 =
               trie_open_namespace tbl.tbl_lids host_query included_query  in
             { tbl_lids = uu____4005; tbl_mods = (uu___176_4004.tbl_mods) })
              ...
              (fun tr  ->
                 fun id  ->
                   fun q  ->
                     fun revq  ->
                       fun namespaces  ->
                         let uu___178_4174 = tr  in
                         let uu____4177 = ins id q revq tr.bindings loaded
                            in
                         { bindings = uu____4177; namespaces })
              (fun tr  -> fun uu____4188  -> tr)
             in
          { tbl_lids = (uu___177_4151.tbl_lids); tbl_mods = uu____4152 }
