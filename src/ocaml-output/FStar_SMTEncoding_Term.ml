        ...
        fun depth  ->
          ...
          then enclosing_name
            ...
            (let uu____4988 = FStar_Util.string_of_int n1  in
             FStar_Util.format2 "%s.%s" enclosing_name uu____4988)
         in
          ...
          then
            let uu____5422 =
              FStar_All.pipe_right (FStar_Util.splitlines c)
                (fun uu___112_5426  ->
                   match uu___112_5426 with | [] -> "" | h::t -> h)
               in
            FStar_Util.format1 "\n; %s" uu____5422
          else ""
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____5993 =
        let uu____6000 = let uu____6003 = mkInteger' i norng  in [uu____6003]
           in
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____6645 =
        let uu____6652 = let uu____6655 = mkInteger' i norng  in [uu____6655]
           in
