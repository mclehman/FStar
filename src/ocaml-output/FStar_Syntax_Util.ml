  ...
  fun u1  ->
    fun u2  ->
      ...
      | (FStar_Syntax_Syntax.U_unknown ,FStar_Syntax_Syntax.U_unknown ) ->
          (Prims.parse_int "0")
      | (FStar_Syntax_Syntax.U_unknown ,uu____814) ->
          ~- (Prims.parse_int "1")
...
let rec eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___165_2055 = if uu___165_2055 then Equal else Unknown
         in
      let equal_iff uu___166_2060 = if uu___166_2060 then Equal else NotEqual
         in
      let eq_and f g = match f with | Equal  -> g () | uu____2074 -> Unknown
         in
      let eq_inj f g =
        match (f, g) with
        | (Equal ,Equal ) -> Equal
            ...
            (FStar_List.fold_left
               (fun acc  ->
                  fun uu____2185  ->
                    ...
                    | ((a1,q1),(a2,q2)) ->
                        let uu____2213 = eq_tm a1 a2  in
                        eq_inj acc uu____2213) Equal) uu____2127
        else NotEqual  in
...
let destruct :
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____2747 =
        let uu____2748 = un_uinst typ1  in uu____2748.FStar_Syntax_Syntax.n
         in
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              ...
              FStar_Pervasives_Native.Some uu____3360
           in
        match bs with
        | [] -> t
        | uu____3373 ->
  ...
  fun phi  ->
    let uu____4819 =
      let uu____4822 =
        let uu____4823 =
          let uu____4838 =
            let uu____4841 = FStar_Syntax_Syntax.as_arg phi  in [uu____4841]
             in
          (t_not, uu____4838)  in
  ...
  fun e  ->
    let uu____4913 =
      let uu____4916 =
        let uu____4917 =
          let uu____4932 =
            let uu____4935 = FStar_Syntax_Syntax.as_arg e  in [uu____4935]
             in
          (b2t_v, uu____4932)  in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6246 =
        ...
        | (lid,arity) ->
            let uu____6255 =
              let uu____6270 = unmeta_monadic f2  in head_and_args uu____6270
               in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6510  ->
                      ...
                      | (t3,imp) ->
                          let uu____6521 = unascribe t3  in (uu____6521, imp)))
               in
                         ...
                         let uu____7395 =
                           let uu____7398 =
                             FStar_Syntax_Syntax.as_arg
                              ...
                              in
                           let uu____7399 =
                             let uu____7402 = FStar_Syntax_Syntax.as_arg q
                                in
                             [uu____7402]  in
                   ...
                   fv,(a1,uu____7506)::(a2,uu____7508)::[]) when
                    ...
                    (match uu____7543 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____7551) ->
                         let uu____7578 = FStar_Syntax_Subst.open_term [b] q
                            in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7806
          ...
          FStar_Parser_Const.effect_Tot_lid uu____7816
         in
      {
  ...
  fun t  ->
    ...
    let uu____7842 =
      let uu____7845 =
        let uu____7846 =
          let uu____7861 =
            let uu____7864 = FStar_Syntax_Syntax.as_arg t  in [uu____7864]
             in
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____8098 = delta_qualifier t  in incr_delta_depth uu____8098
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____8120 = let uu____8135 = unmeta e  in head_and_args uu____8135
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8412 =
          let uu____8413 =
            let uu____8414 = FStar_Syntax_Syntax.iarg typ  in [uu____8414]
             in
...
let rec sizeof : FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____9637 ->
        let uu____9662 =
          let uu____9663 = FStar_Syntax_Subst.compress t  in
          sizeof uu____9663  in
            ...
            (fun acc  ->
               fun uu____9710  ->
                 ...
                 | (bv,uu____9716) ->
                     ...
                     acc + uu____9717) (Prims.parse_int "0") bs
           in
          ...
          let uu____9810 =
            let uu____9813 =
              let uu____9814 =
                let uu____9821 =
                  let uu____9822 =
                    let uu____9831 = FStar_Dyn.mkdyn b  in
                    (uu____9831, s, ty)  in
