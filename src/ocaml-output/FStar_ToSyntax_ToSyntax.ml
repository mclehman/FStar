...
and free_type_vars:
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Parser_AST.Quote uu____853 -> []
      | FStar_Parser_AST.Antiquote uu____854 -> []
      | FStar_Parser_AST.Seq uu____855 -> []
let head_and_args:
  ...
  fun t  ->
    let rec aux args t1 =
      let uu____903 =
        let uu____904 = unparen t1 in uu____904.FStar_Parser_AST.tm in
           ...
           FStar_All.pipe_right ftv
             (FStar_List.map
                (fun x  ->
                   let uu____986 =
                     let uu____987 =
                       let uu____992 = tm_type x.FStar_Ident.idRange in
                       (x, uu____992) in
                     FStar_Parser_AST.TAnnotated uu____987 in
                   FStar_Parser_AST.mk_binder uu____986 x.FStar_Ident.idRange
...
let close_fun:
  ...
  fun env  ->
    fun t  ->
      let ftv =
        let uu____1007 = free_type_vars env t in
        FStar_All.pipe_left sort_ftv uu____1007 in
      if (FStar_List.length ftv) = (Prims.parse_int "0")
      then t
      else
        (let binders =
           FStar_All.pipe_right ftv
             (FStar_List.map
                (fun x  ->
                   let uu____1025 =
                     let uu____1026 =
                       let uu____1031 = tm_type x.FStar_Ident.idRange in
                       (x, uu____1031) in
                     FStar_Parser_AST.TAnnotated uu____1026 in
                   FStar_Parser_AST.mk_binder uu____1025
                     x.FStar_Ident.idRange FStar_Parser_AST.Type_level
                     (FStar_Pervasives_Native.Some FStar_Parser_AST.Implicit))) in
         let t1 =
           let uu____1033 =
             let uu____1034 = unparen t in uu____1034.FStar_Parser_AST.tm in
           match uu____1033 with
           | FStar_Parser_AST.Product uu____1035 -> t
           | uu____1042 ->
               FStar_Parser_AST.mk_term
...
let rec is_var_pattern: FStar_Parser_AST.pattern -> Prims.bool =
  fun p  ->
    ...
    | FStar_Parser_AST.PatTvar (uu____1083,uu____1084) -> true
    | FStar_Parser_AST.PatVar (uu____1089,uu____1090) -> true
    | FStar_Parser_AST.PatAscribed (p1,uu____1096) -> is_var_pattern p1
    | uu____1097 -> false
let rec is_app_pattern: FStar_Parser_AST.pattern -> Prims.bool =
  fun p  ->
    match p.FStar_Parser_AST.pat with
    | FStar_Parser_AST.PatAscribed (p1,uu____1103) -> is_app_pattern p1
    | FStar_Parser_AST.PatApp
        ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatVar uu____1104;
           FStar_Parser_AST.prange = uu____1105;_},uu____1106)
        -> true
    | uu____1117 -> false
    ...
    fun is_top_level1  ->
      fun p  ->
        ...
        | FStar_Parser_AST.PatAscribed (p1,t) ->
            let uu____1165 = destruct_app_pattern env is_top_level1 p1 in
            (match uu____1165 with
             | (name,args,uu____1196) ->
                 (name, args, (FStar_Pervasives_Native.Some t)))
        | FStar_Parser_AST.PatApp
            ({
               FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id,uu____1222);
               FStar_Parser_AST.prange = uu____1223;_},args)
            when is_top_level1 ->
            let uu____1233 =
              let uu____1238 = FStar_ToSyntax_Env.qualify env id in
              FStar_Util.Inr uu____1238 in
            (uu____1233, args, FStar_Pervasives_Native.None)
        | FStar_Parser_AST.PatApp
            ({
               FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id,uu____1248);
               FStar_Parser_AST.prange = uu____1249;_},args)
            -> ((FStar_Util.Inl id), args, FStar_Pervasives_Native.None)
        | uu____1267 -> failwith "Not an app pattern"
let rec gather_pattern_bound_vars_maybe_top:
  ...
  fun acc  ->
    fun p  ->
      ...
      | FStar_Parser_AST.PatConst uu____1307 -> acc
      | FStar_Parser_AST.PatVar
          (uu____1308,FStar_Pervasives_Native.Some (FStar_Parser_AST.Implicit
           ))
          -> acc
      | FStar_Parser_AST.PatName uu____1311 -> acc
      | FStar_Parser_AST.PatTvar uu____1312 -> acc
      | FStar_Parser_AST.PatOp uu____1319 -> acc
      | FStar_Parser_AST.PatApp (phead,pats) ->
          gather_pattern_bound_vars_from_list (phead :: pats)
      | FStar_Parser_AST.PatVar (x,uu____1327) -> FStar_Util.set_add x acc
      | FStar_Parser_AST.PatList pats ->
          gather_pattern_bound_vars_from_list pats
      | FStar_Parser_AST.PatTuple (pats,uu____1336) ->
          gather_pattern_bound_vars_from_list pats
      ...
      | FStar_Parser_AST.PatRecord guarded_pats ->
          ...
          gather_pattern_bound_vars_from_list uu____1351
      | FStar_Parser_AST.PatAscribed (pat,uu____1359) ->
      ...
      fun uu___214_1492  ->
        ...
        | (FStar_Pervasives_Native.Some a,k) ->
            ...
            (match uu____1513 with
             | (env1,a1) ->
                 (((let uu___237_1533 = a1 in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___237_1533.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___237_1533.FStar_Syntax_Syntax.index);
    ...
    fun repr  ->
      fun uu____4310  ->
        fun range  ->
          ...
          | (signedness,width) ->
              let uu____4318 = FStar_Const.bounds signedness width in
                            ...
                            | FStar_Syntax_Syntax.Tm_fvar fv ->
                                ...
                                let private_fv =
                                  ...
                                  FStar_Syntax_Syntax.lid_as_fv private_lid
                                    uu____4363 fv.FStar_Syntax_Syntax.fv_qual in
                                let uu___240_4364 = intro_term in
                                {
                                  FStar_Syntax_Syntax.n =
                                    (FStar_Syntax_Syntax.Tm_fvar private_fv);
                                  FStar_Syntax_Syntax.pos =
                                    (uu___240_4364.FStar_Syntax_Syntax.pos);
                                  FStar_Syntax_Syntax.vars =
                                    (uu___240_4364.FStar_Syntax_Syntax.vars)
                                }
                            | uu____4365 ->
                                failwith
  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let setpos e =
          let uu___241_4542 = e in
          {
            FStar_Syntax_Syntax.n = (uu___241_4542.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = (top.FStar_Parser_AST.range);
            FStar_Syntax_Syntax.vars =
              (uu___241_4542.FStar_Syntax_Syntax.vars)
          } in
        let uu____4545 =
              ...
              FStar_All.pipe_right uu____4628
                (FStar_List.map
                   (fun t  ->
                      ...
                      FStar_Syntax_Syntax.as_arg uu____4639)) in
            let uu____4640 =
              let uu____4645 =
                FStar_Parser_Const.mk_tuple_lid (FStar_List.length targs)
                  top.FStar_Parser_AST.range in
              FStar_ToSyntax_Env.fail_or env
                (FStar_ToSyntax_Env.try_lookup_lid env) uu____4645 in
                     ...
                     FStar_All.pipe_right args
                       (FStar_List.map
                          (fun t  ->
                             ...
                             (uu____4710, FStar_Pervasives_Native.None))) in
                   mk1 (FStar_Syntax_Syntax.Tm_app (op, args1))
                 else op)
        | FStar_Parser_AST.Construct (n1,(a,uu____4724)::[]) when
            n1.FStar_Ident.str = "SMTPat" ->
            let uu____4739 =
              let uu___242_4740 = top in
              let uu____4741 =
                let uu____4742 =
                  let uu____4749 =
                    let uu___243_4750 = top in
                    let uu____4751 =
                      let uu____4752 =
                      ...
                      FStar_Parser_AST.Var uu____4752 in
                    {
                      ...
                      FStar_Parser_AST.range =
                        (uu___243_4750.FStar_Parser_AST.range);
                      FStar_Parser_AST.level =
                        (uu___243_4750.FStar_Parser_AST.level)
                    } in
                ...
                FStar_Parser_AST.App uu____4742 in
              {
                ...
                FStar_Parser_AST.range =
                  (uu___242_4740.FStar_Parser_AST.range);
                FStar_Parser_AST.level =
                  (uu___242_4740.FStar_Parser_AST.level)
              } in
            desugar_term_maybe_top top_level env uu____4739
        | FStar_Parser_AST.Construct (n1,(a,uu____4755)::[]) when
            n1.FStar_Ident.str = "SMTPatT" ->
            let uu____4770 =
              let uu___244_4771 = top in
              let uu____4772 =
                let uu____4773 =
                  let uu____4780 =
                    let uu___245_4781 = top in
                    let uu____4782 =
                      let uu____4783 =
                        FStar_Ident.lid_of_path ["Prims"; "smt_pat"]
                          top.FStar_Parser_AST.range in
                      FStar_Parser_AST.Var uu____4783 in
                    {
                      ...
                      FStar_Parser_AST.range =
                        (uu___245_4781.FStar_Parser_AST.range);
                      FStar_Parser_AST.level =
                        (uu___245_4781.FStar_Parser_AST.level)
                    } in
                ...
                FStar_Parser_AST.App uu____4773 in
              {
                ...
                FStar_Parser_AST.range =
                  (uu___244_4771.FStar_Parser_AST.range);
                FStar_Parser_AST.level =
                  (uu___244_4771.FStar_Parser_AST.level)
              } in
            desugar_term_maybe_top top_level env uu____4770
        | FStar_Parser_AST.Construct (n1,(a,uu____4786)::[]) when
            n1.FStar_Ident.str = "SMTPatOr" ->
            let uu____4801 =
              let uu___246_4802 = top in
              let uu____4803 =
                let uu____4804 =
                  let uu____4811 =
                    let uu___247_4812 = top in
                    let uu____4813 =
                      let uu____4814 =
                      ...
                      FStar_Parser_AST.Var uu____4814 in
                    {
                      ...
                      FStar_Parser_AST.range =
                        (uu___247_4812.FStar_Parser_AST.range);
                      FStar_Parser_AST.level =
                        (uu___247_4812.FStar_Parser_AST.level)
                    } in
                ...
                FStar_Parser_AST.App uu____4804 in
              {
                ...
                FStar_Parser_AST.range =
                  (uu___246_4802.FStar_Parser_AST.range);
                FStar_Parser_AST.level =
                  (uu___246_4802.FStar_Parser_AST.level)
              } in
        ...
        | FStar_Parser_AST.Projector (l,i) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let name =
                let uu____4902 = FStar_ToSyntax_Env.try_lookup_datacon env l in
        ...
        | FStar_Parser_AST.Construct (l,args) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let uu____4989 = FStar_ToSyntax_Env.try_lookup_datacon env l in
              match uu____4989 with
              | FStar_Pervasives_Native.Some head1 ->
                  let uu____4993 =
                    let uu____5000 = mk1 (FStar_Syntax_Syntax.Tm_fvar head1) in
                    (uu____5000, true) in
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___248_5361 = x in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___248_5361.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___248_5361.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })),
                                           FStar_Pervasives_Native.None)]),
                                     uu____5328)))) (env, [], [])
            ...
            (match uu____5168 with
             | (env1,uu____5385,targs) ->
                 let uu____5407 =
                   ...
                   FStar_ToSyntax_Env.fail_or env1
                     (FStar_ToSyntax_Env.try_lookup_lid env1) uu____5412 in
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____5429 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___219_5461 =
                   match uu___219_5461 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
                     ...
                     | (env1,ftvs) ->
                         (match pat.FStar_Parser_AST.pat with
                          | FStar_Parser_AST.PatAscribed (uu____5608,t) ->
                              ...
                              (env1, uu____5610)
                          | uu____5618 -> (env1, ftvs))) (env, []) binders1 in
            (match uu____5562 with
             | (uu____5623,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___220_5676 =
                   match uu___220_5676 with
                   | [] ->
        ...
        | FStar_Parser_AST.App
            ...
            let rec aux universes e =
              let uu____6273 =
                let uu____6274 = unparen e in uu____6274.FStar_Parser_AST.tm in
            ...
            aux [] top
        | FStar_Parser_AST.App uu____6284 ->
            let rec aux args e =
              let uu____6316 =
                let uu____6317 = unparen e in uu____6317.FStar_Parser_AST.tm in
              match uu____6316 with
              | FStar_Parser_AST.App (e1,t,imp) when
                  imp <> FStar_Parser_AST.UnivApp ->
                  let arg =
                    let uu____6330 = desugar_term env t in
                    FStar_All.pipe_left (arg_withimp_e imp) uu____6330 in
                  aux (arg :: args) e1
              | uu____6343 ->
                  let head1 = desugar_term env e in
        ...
        | FStar_Parser_AST.Bind (x,t1,t2) ->
            ...
            let bind1 =
              let uu____6369 =
                ...
                FStar_Parser_AST.Var uu____6370 in
              FStar_Parser_AST.mk_term uu____6369 x.FStar_Ident.idRange
                FStar_Parser_AST.Expr in
            let uu____6371 =
              FStar_Parser_AST.mkExplicitApp bind1 [t1; k]
                top.FStar_Parser_AST.range in
            desugar_term env uu____6371
        | FStar_Parser_AST.Seq (t1,t2) ->
            let uu____6374 =
              ...
              FStar_Syntax_Syntax.Tm_meta uu____6375 in
            mk1 uu____6374
        | FStar_Parser_AST.LetOpen (lid,e) ->
            let env1 = FStar_ToSyntax_Env.push_namespace env lid in
            let uu____6400 =
              let uu____6405 = FStar_ToSyntax_Env.expect_typ env1 in
              if uu____6405 then desugar_typ else desugar_term in
            uu____6400 env1 e
        | FStar_Parser_AST.Let (qual1,(pat,_snd)::_tl,body) ->
            let is_rec = qual1 = FStar_Parser_AST.Rec in
            let ds_let_rec_or_app uu____6438 =
                ...
                FStar_All.pipe_right bindings
                  (FStar_List.map
                     (fun uu____6524  ->
                        ...
                        | (p,def) ->
                            let uu____6549 = is_app_pattern p in
                            if uu____6549
                            then
                              let uu____6568 =
                                    ...
                                    | FStar_Parser_AST.PatAscribed
                                        ...
                                        then
                                          ...
                                          (((FStar_Util.Inl id), [],
                                             (FStar_Pervasives_Native.Some t)),
                                            def)
                                    | FStar_Parser_AST.PatVar (id,uu____6769)
                                        ->
                                        if top_level
                                        then
                                          let uu____6792 =
              ...
              let uu____6877 =
                FStar_List.fold_left
                  (fun uu____6937  ->
                     fun uu____6938  ->
                       match (uu____6937, uu____6938) with
                       | ((env1,fnames,rec_bindings),((f,uu____7021,uu____7022),uu____7023))
                           ->
                           let uu____7102 =
                             match f with
                             | FStar_Util.Inl x ->
                                 ...
                                 (match uu____7128 with
                                  | (env2,xx) ->
                                      let uu____7147 =
                                        ...
                                        uu____7150 :: rec_bindings in
                                      (env2, (FStar_Util.Inl xx), uu____7147))
                             | FStar_Util.Inr l ->
                                 let uu____7158 =
                                   FStar_ToSyntax_Env.push_top_level_rec_binding
                                     env1 l.FStar_Ident.ident
                                     FStar_Syntax_Syntax.Delta_equational in
                                 (uu____7158, (FStar_Util.Inr l),
                                   rec_bindings) in
              ...
              | (env',fnames,rec_bindings) ->
                  ...
                  let desugar_one_def env1 lbname uu____7284 =
                    match uu____7284 with
                    | ((uu____7307,args,result_t),def) ->
                        let args1 =
                          FStar_All.pipe_right args
                            (FStar_List.map replace_unit_pattern) in
                        let def1 =
                          ...
                          | FStar_Pervasives_Native.Some t ->
                              let t1 =
                                let uu____7351 = is_comp_type env1 t in
                                if uu____7351
                                then
                                  ((let uu____7353 =
                                      FStar_All.pipe_right args1
                                        (FStar_List.tryFind
                                           (fun x  ->
                                              let uu____7363 =
                                                is_var_pattern x in
                                              Prims.op_Negation uu____7363)) in
                                  ...
                                  (let uu____7366 =
                                     ((FStar_Options.ml_ish ()) &&
                                        (let uu____7368 =
                                         ...
                                         FStar_Option.isSome uu____7368))
                                       &&
                              ...
                              FStar_Parser_AST.mk_term
                                ...
                                uu____7372 FStar_Parser_AST.Expr in
                        let def2 =
                          match args1 with
                          | [] -> def1
                          | uu____7376 ->
                              ...
                              let uu____7391 =
                                let uu____7392 =
                                  FStar_Syntax_Util.incr_delta_qualifier
                                    body1 in
                                FStar_Syntax_Syntax.lid_as_fv l uu____7392
                                  FStar_Pervasives_Native.None in
                              FStar_Util.Inr uu____7391 in
                        let body2 =
                          if is_rec
                  ...
                  let uu____7426 =
                    let uu____7427 =
                      ...
                      ((is_rec, lbs), uu____7440) in
                    FStar_Syntax_Syntax.Tm_let uu____7427 in
                  FStar_All.pipe_left mk1 uu____7426 in
                  ...
                  let tm =
                    ...
                    | LetBinder (l,t) ->
                        ...
                        let fv =
                          ...
                          FStar_Syntax_Syntax.lid_as_fv l uu____7498
                            FStar_Pervasives_Native.None in
                        FStar_All.pipe_left mk1
                        ...
                        let body2 =
                          ...
                          | {
                              FStar_Syntax_Syntax.v =
                                FStar_Syntax_Syntax.Pat_wild uu____7513;
                              FStar_Syntax_Syntax.p = uu____7514;_}::[] ->
                              body1
                          | uu____7519 ->
                              let uu____7522 =
                                let uu____7525 =
                                  ...
                                  FStar_Syntax_Syntax.Tm_match uu____7526 in
                          ...
                          let uu____7561 =
                            let uu____7574 =
                              let uu____7575 =
                                ...
                                [uu____7576] in
                              FStar_Syntax_Subst.close uu____7575 body2 in
                            ((false,
                               [mk_lb
                                  ((FStar_Util.Inl x),
                                    (x.FStar_Syntax_Syntax.sort), t12)]),
                              uu____7574) in
                          FStar_Syntax_Syntax.Tm_let uu____7561 in
                        FStar_All.pipe_left mk1 uu____7560 in
                  if is_mutable
                  then
                    FStar_All.pipe_left mk1
                      (FStar_Syntax_Syntax.Tm_meta
            ...
            let uu____7602 = is_rec || (is_app_pattern pat) in
            if uu____7602
              ...
              let uu____7611 =
                let uu____7612 =
                  FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.bool_lid
                    FStar_Syntax_Syntax.Delta_constant
                    FStar_Pervasives_Native.None in
                FStar_Syntax_Syntax.Tm_fvar uu____7612 in
              mk1 uu____7611 in
            let uu____7613 =
              let uu____7614 =
                let uu____7637 =
                  let uu____7640 = desugar_term env t1 in
                  FStar_Syntax_Util.ascribe uu____7640
                ...
                let uu____7661 =
                  let uu____7676 =
                    ...
                    let uu____7692 = desugar_term env t2 in
                    (uu____7689, FStar_Pervasives_Native.None, uu____7692) in
                  let uu____7701 =
                    let uu____7716 =
                      let uu____7729 =
                        FStar_Syntax_Syntax.withinfo
                      ...
                      let uu____7732 = desugar_term env t3 in
                      (uu____7729, FStar_Pervasives_Native.None, uu____7732) in
                    [uu____7716] in
                  uu____7676 :: uu____7701 in
                (uu____7637, uu____7661) in
              FStar_Syntax_Syntax.Tm_match uu____7614 in
            mk1 uu____7613
        ...
        | FStar_Parser_AST.Match (e,branches) ->
            let desugar_branch uu____7873 =
              match uu____7873 with
              | (pat,wopt,b) ->
                  let uu____7891 = desugar_match_pat env pat in
                   ...
                   | (env1,pat1) ->
                       let wopt1 =
                         ...
                         | FStar_Pervasives_Native.Some e1 ->
                             let uu____7912 = desugar_term env1 e1 in
                             FStar_Pervasives_Native.Some uu____7912 in
                       let b1 = desugar_term env1 b in
                       desugar_disjunctive_pattern pat1 wopt1 b1) in
            let uu____7914 =
              let uu____7915 =
                let uu____7938 = desugar_term env e in
                let uu____7939 = FStar_List.collect desugar_branch branches in
                (uu____7938, uu____7939) in
              FStar_Syntax_Syntax.Tm_match uu____7915 in
            FStar_All.pipe_left mk1 uu____7914
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            let annot =
              let uu____7968 = is_comp_type env t in
              if uu____7968
              then
                let uu____7975 = desugar_comp t.FStar_Parser_AST.range env t in
                FStar_Util.Inr uu____7975
              else
                (let uu____7981 = desugar_term env t in
                 FStar_Util.Inl uu____7981) in
            let tac_opt1 = FStar_Util.map_opt tac_opt (desugar_term env) in
            let uu____7987 =
              let uu____7988 =
                let uu____8015 = desugar_term env e in
                (uu____8015, (annot, tac_opt1), FStar_Pervasives_Native.None) in
              FStar_Syntax_Syntax.Tm_ascribed uu____7988 in
            FStar_All.pipe_left mk1 uu____7987
        | FStar_Parser_AST.Record (uu____8040,[]) ->
            FStar_Exn.raise
              (FStar_Errors.Error
        ...
        | FStar_Parser_AST.Record (eopt,fields) ->
            ...
            let user_ns =
              let uu____8077 = FStar_List.hd fields in
              match uu____8077 with | (f,uu____8089) -> f.FStar_Ident.ns in
            let get_field xopt f =
              ...
              match found with
              | FStar_Pervasives_Native.Some (uu____8143,e) -> (fn, e)
              | FStar_Pervasives_Native.None  ->
                  (match xopt with
                   | FStar_Pervasives_Native.None  ->
                       let uu____8157 =
                         let uu____8158 =
                           ...
                           (uu____8163, (top.FStar_Parser_AST.range)) in
                         FStar_Errors.Error uu____8158 in
                       FStar_Exn.raise uu____8157
                   | FStar_Pervasives_Native.Some x ->
                       (fn,
                         (FStar_Parser_AST.mk_term
                                  ...
                                  let uu____8224 =
                                    let uu____8225 =
                                      get_field FStar_Pervasives_Native.None
                                        f in
                                    FStar_All.pipe_left
                                      FStar_Pervasives_Native.snd uu____8225 in
                                  (uu____8224, FStar_Parser_AST.Nothing))) in
                    (user_constrname, uu____8182) in
                  FStar_Parser_AST.Construct uu____8171
              | FStar_Pervasives_Native.Some e ->
                  let x = FStar_Ident.gen e.FStar_Parser_AST.range in
                  let xterm =
                    let uu____8243 =
                      let uu____8244 = FStar_Ident.lid_of_ids [x] in
                      FStar_Parser_AST.Var uu____8244 in
                    FStar_Parser_AST.mk_term uu____8243 x.FStar_Ident.idRange
                      FStar_Parser_AST.Expr in
                  let record1 =
                    let uu____8246 =
                      let uu____8259 =
                      ...
                      (FStar_Pervasives_Native.None, uu____8259) in
                    FStar_Parser_AST.Record uu____8246 in
                  FStar_Parser_AST.Let
                    (FStar_Parser_AST.NoLetQualifier,
                      [((FStar_Parser_AST.mk_pattern
                           (FStar_Parser_AST.PatVar
                    ...
                    FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app
                      ({
                         FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar
                           fv;
                         FStar_Syntax_Syntax.pos = uu____8327;
                         FStar_Syntax_Syntax.vars = uu____8328;_},args);
                    FStar_Syntax_Syntax.pos = uu____8330;
                    FStar_Syntax_Syntax.vars = uu____8331;_},FStar_Syntax_Syntax.Meta_desugared
                  (FStar_Syntax_Syntax.Data_app ))
                 ->
                 let e1 =
                   let uu____8359 =
                         ...
                         let uu____8376 =
                           let uu____8379 =
                             let uu____8380 =
                               ...
                               ((record.FStar_ToSyntax_Env.typename),
                                 uu____8387) in
                             FStar_Syntax_Syntax.Record_ctor uu____8380 in
                           FStar_Pervasives_Native.Some uu____8379 in
                         FStar_Syntax_Syntax.fvar
                           (FStar_Ident.set_lid_range
                              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                              e.FStar_Syntax_Syntax.pos)
                           FStar_Syntax_Syntax.Delta_constant uu____8376 in
                       (uu____8375, args) in
                     FStar_Syntax_Syntax.Tm_app uu____8360 in
                   FStar_All.pipe_left mk1 uu____8359 in
                 FStar_All.pipe_left mk1
                   (FStar_Syntax_Syntax.Tm_meta
                      (e1,
                        (FStar_Syntax_Syntax.Meta_desugared
              ...
              | (constrname,is_rec) ->
                  ...
                  let uu____8441 =
                    let uu____8442 =
                      ...
                      let uu____8458 =
                        let uu____8461 = FStar_Syntax_Syntax.as_arg e1 in
                        [uu____8461] in
                      (uu____8457, uu____8458) in
                    FStar_Syntax_Syntax.Tm_app uu____8442 in
                  FStar_All.pipe_left mk1 uu____8441))
        | FStar_Parser_AST.NamedTyp (uu____8466,e) -> desugar_term env e
        ...
        | FStar_Parser_AST.Quote e ->
            let uu____8470 =
              let uu____8471 =
                let uu____8478 =
                  let uu____8479 =
                    let uu____8486 = desugar_term env e in (uu____8486, ()) in
                  FStar_Syntax_Syntax.Meta_quoted uu____8479 in
                (FStar_Syntax_Syntax.tun, uu____8478) in
              FStar_Syntax_Syntax.Tm_meta uu____8471 in
            FStar_All.pipe_left mk1 uu____8470
        | FStar_Parser_AST.Antiquote e ->
            let uu____8490 =
              let uu____8491 =
                let uu____8498 = desugar_term env e in
                (uu____8498, FStar_Syntax_Syntax.Meta_antiquoted) in
              FStar_Syntax_Syntax.Tm_meta uu____8491 in
            FStar_All.pipe_left mk1 uu____8490
        | uu____8501 when
        ...
        | uu____8502 ->
            FStar_Parser_AST.error "Unexpected term" top
              top.FStar_Parser_AST.range
        | FStar_Parser_AST.Let (uu____8503,uu____8504,uu____8505) ->
            failwith "Not implemented yet"
        | FStar_Parser_AST.QForall (uu____8518,uu____8519,uu____8520) ->
            failwith "Not implemented yet"
        | FStar_Parser_AST.QExists (uu____8533,uu____8534,uu____8535) ->
            failwith "Not implemented yet"
and not_ascribed: FStar_Parser_AST.term -> Prims.bool =
  fun t  ->
    match t.FStar_Parser_AST.tm with
    | FStar_Parser_AST.Ascribed uu____8549 -> false
    | uu____8558 -> true
      ...
      FStar_All.pipe_right args
        (FStar_List.map
           (fun uu____8605  ->
              ...
              | (a,imp) ->
                  let uu____8618 = desugar_term env a in
                  arg_withimp_e imp uu____8618))
and desugar_comp:
  FStar_Range.range ->
    FStar_ToSyntax_Env.env ->
      FStar_Parser_AST.term ->
  ...
  fun r  ->
    fun env  ->
      fun t  ->
        ...
        let is_requires uu____8637 =
          match uu____8637 with
          | (t1,uu____8643) ->
              let uu____8644 =
                let uu____8645 = unparen t1 in uu____8645.FStar_Parser_AST.tm in
              (match uu____8644 with
               | FStar_Parser_AST.Requires uu____8646 -> true
               | uu____8653 -> false) in
        let is_ensures uu____8661 =
          match uu____8661 with
          | (t1,uu____8667) ->
              let uu____8668 =
                let uu____8669 = unparen t1 in uu____8669.FStar_Parser_AST.tm in
              (match uu____8668 with
               | FStar_Parser_AST.Ensures uu____8670 -> true
               | uu____8677 -> false) in
        let is_app head1 uu____8688 =
          match uu____8688 with
          | (t1,uu____8694) ->
              let uu____8695 =
                let uu____8696 = unparen t1 in uu____8696.FStar_Parser_AST.tm in
              (match uu____8695 with
               ...
               | uu____8702 -> false) in
        let is_smt_pat uu____8710 =
          match uu____8710 with
          | (t1,uu____8716) ->
              let uu____8717 =
                let uu____8718 = unparen t1 in uu____8718.FStar_Parser_AST.tm in
               ...
               | FStar_Parser_AST.Construct
                   (cons1,({
                             FStar_Parser_AST.tm = FStar_Parser_AST.Var
                               smtpat;
                             FStar_Parser_AST.range = uu____8764;
                             FStar_Parser_AST.level = uu____8765;_},uu____8766)::uu____8767::[])
                   ->
                   (FStar_Ident.lid_equals cons1 FStar_Parser_Const.cons_lid)
                     &&
                     (FStar_Util.for_some
        ...
        let pre_process_comp_typ t1 =
          let uu____8820 = head_and_args t1 in
              ...
              (match head1.FStar_Parser_AST.tm with
               | FStar_Parser_AST.Name lemma when
                   ...
                   let args1 =
                     ...
                     | ens::smtpat::[] when
                         (((let uu____9079 = is_requires ens in
                            Prims.op_Negation uu____9079) &&
                             (let uu____9081 = is_smt_pat ens in
                              Prims.op_Negation uu____9081))
                            &&
                            (let uu____9083 = is_decreases ens in
               ...
               | FStar_Parser_AST.Name l when
                   ...
                   (uu____9372, args)
               | FStar_Parser_AST.Name l when
                   (let uu____9400 = FStar_ToSyntax_Env.current_module env in
                    FStar_Ident.lid_equals uu____9400
               ...
               | FStar_Parser_AST.Name l when
                   (let uu____9418 = FStar_ToSyntax_Env.current_module env in
                    FStar_Ident.lid_equals uu____9418
                      FStar_Parser_Const.prims_lid)
               ...
               | uu____9456 ->
                   let default_effect =
                     let uu____9458 = FStar_Options.ml_ish () in
                     if uu____9458
        ...
        let uu____9485 = pre_process_comp_typ t in
        match uu____9485 with
        | ((eff,cattributes),args) ->
            (if (FStar_List.length args) = (Prims.parse_int "0")
             then
               (let uu____9534 =
                  let uu____9535 = FStar_Syntax_Print.lid_to_string eff in
                  FStar_Util.format1 "Not enough args to effect %s"
                    uu____9535 in
                fail uu____9534)
             else ();
             (let is_universe uu____9544 =
                match uu____9544 with
                | (uu____9549,imp) -> imp = FStar_Parser_AST.UnivApp in
              let uu____9551 = FStar_Util.take is_universe args in
              ...
              | (universes,args1) ->
                  ...
                  let uu____9617 =
                    let uu____9632 = FStar_List.hd args1 in
                    let uu____9641 = FStar_List.tl args1 in
                    (uu____9632, uu____9641) in
                                   ...
                                   (fun uu____9899  ->
                                      ...
                                      | (t1,uu____9909) ->
                                          (match t1.FStar_Syntax_Syntax.n
                                           with
                                           | FStar_Syntax_Syntax.Tm_app
                                               (uu____9918,(arg,uu____9920)::[])
                                               ->
                                               FStar_Syntax_Syntax.DECREASES
                                                 arg
                                           | uu____9949 -> failwith "impos"))) in
  ...
  fun env  ->
    fun f  ->
      let connective s =
        ...
        | uu____10206 -> FStar_Pervasives_Native.None in
      let mk1 t =
        FStar_Syntax_Syntax.mk t FStar_Pervasives_Native.None
          f.FStar_Parser_AST.range in
      let setpos t =
        let uu___249_10223 = t in
        {
          FStar_Syntax_Syntax.n = (uu___249_10223.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars =
            (uu___249_10223.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___250_10257 = b in
             {
               FStar_Parser_AST.b = (uu___250_10257.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___250_10257.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___250_10257.FStar_Parser_AST.aqual)
             }) in
          ...
          FStar_List.map
            (fun es  ->
               FStar_All.pipe_right es
                 (FStar_List.map
                    (fun e  ->
                       let uu____10316 = desugar_term env1 e in
                       FStar_All.pipe_left
                         (arg_withimp_t FStar_Parser_AST.Nothing) uu____10316)))
            pats1 in
        match tk with
        | (FStar_Pervasives_Native.Some a,k) ->
            let uu____10329 = FStar_ToSyntax_Env.push_bv env a in
            (match uu____10329 with
             | (env1,a1) ->
                 let a2 =
                   let uu___251_10339 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___251_10339.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___251_10339.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
                 ...
                 let body3 =
                   let uu____10375 =
                     let uu____10378 =
                       let uu____10379 = FStar_Syntax_Syntax.mk_binder a2 in
                       [uu____10379] in
                     no_annot_abs uu____10378 body2 in
                   FStar_All.pipe_left setpos uu____10375 in
                 let uu____10384 =
                   let uu____10385 =
                     let uu____10400 =
                       FStar_Syntax_Syntax.fvar
                         ...
                         FStar_Pervasives_Native.None in
                     let uu____10401 =
                       let uu____10404 = FStar_Syntax_Syntax.as_arg body3 in
                       [uu____10404] in
                     (uu____10400, uu____10401) in
                   FStar_Syntax_Syntax.Tm_app uu____10385 in
                 FStar_All.pipe_left mk1 uu____10384)
        | uu____10409 -> failwith "impossible" in
      let push_quant q binders pats body =
        match binders with
        | b::b'::_rest ->
            let rest = b' :: _rest in
            let body1 =
              let uu____10481 = q (rest, pats, body) in
              let uu____10488 =
                FStar_Range.union_ranges b'.FStar_Parser_AST.brange
                  body.FStar_Parser_AST.range in
              FStar_Parser_AST.mk_term uu____10481 uu____10488
                FStar_Parser_AST.Formula in
            let uu____10489 = q ([b], [], body1) in
            FStar_Parser_AST.mk_term uu____10489 f.FStar_Parser_AST.range
              FStar_Parser_AST.Formula
        | uu____10498 -> failwith "impossible" in
      let uu____10501 =
        let uu____10502 = unparen f in uu____10502.FStar_Parser_AST.tm in
      ...
      | FStar_Parser_AST.QForall ([],uu____10509,uu____10510) ->
          failwith "Impossible: Quantifier without binders"
      | FStar_Parser_AST.QExists ([],uu____10521,uu____10522) ->
          failwith "Impossible: Quantifier without binders"
      | FStar_Parser_AST.QForall (_1::_2::_3,pats,body) ->
          ...
          let uu____10553 =
            push_quant (fun x  -> FStar_Parser_AST.QForall x) binders pats
              body in
          desugar_formula env uu____10553
      | FStar_Parser_AST.QExists (_1::_2::_3,pats,body) ->
          let binders = _1 :: _2 :: _3 in
          let uu____10589 =
            push_quant (fun x  -> FStar_Parser_AST.QExists x) binders pats
              body in
          desugar_formula env uu____10589
      | FStar_Parser_AST.QForall (b::[],pats,body) ->
          desugar_quant FStar_Parser_Const.forall_lid b pats body
      | FStar_Parser_AST.QExists (b::[],pats,body) ->
          desugar_quant FStar_Parser_Const.exists_lid b pats body
      | FStar_Parser_AST.Paren f1 -> desugar_formula env f1
      | uu____10632 -> desugar_term env f
and typars_of_binders:
  ...
  fun env  ->
    fun bs  ->
          ...
          (fun uu____10673  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___252_10725 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___252_10725.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___252_10725.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___252_10725.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (FStar_Pervasives_Native.Some a,k) ->
                        let uu____10742 = FStar_ToSyntax_Env.push_bv env1 a in
                        (match uu____10742 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___253_10762 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___253_10762.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___253_10762.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
      ...
      match uu____10637 with | (env1,tpars) -> (env1, (FStar_List.rev tpars))
and desugar_binder:
  FStar_ToSyntax_Env.env ->
    FStar_Parser_AST.binder ->
      (FStar_Ident.ident FStar_Pervasives_Native.option,FStar_Syntax_Syntax.term)
  ...
  fun env  ->
    fun b  ->
      ...
      | FStar_Parser_AST.TAnnotated (x,t) ->
          let uu____10866 = desugar_typ env t in
          ((FStar_Pervasives_Native.Some x), uu____10866)
      | FStar_Parser_AST.Annotated (x,t) ->
          let uu____10871 = desugar_typ env t in
          ((FStar_Pervasives_Native.Some x), uu____10871)
      | FStar_Parser_AST.TVariable x ->
          let uu____10875 =
            FStar_Syntax_Syntax.mk
              (FStar_Syntax_Syntax.Tm_type FStar_Syntax_Syntax.U_unknown)
              FStar_Pervasives_Native.None x.FStar_Ident.idRange in
          ((FStar_Pervasives_Native.Some x), uu____10875)
      | FStar_Parser_AST.NoName t ->
          let uu____10883 = desugar_typ env t in
          (FStar_Pervasives_Native.None, uu____10883)
      ...
      fun datas  ->
        let quals1 =
          FStar_All.pipe_right quals
            (FStar_List.filter
               (fun uu___221_10919  ->
                  match uu___221_10919 with
                  | FStar_Syntax_Syntax.Abstract  -> true
                  | FStar_Syntax_Syntax.Private  -> true
                  | uu____10920 -> false)) in
        let quals2 q =
          let uu____10931 =
            (let uu____10934 = FStar_ToSyntax_Env.iface env in
          ...
          (FStar_List.map
             (fun d  ->
                    ...
                    FStar_Syntax_Syntax.Discriminator d] in
                {
                  ...
                  FStar_Syntax_Syntax.sigquals = uu____10947;
      ...
      fun env  ->
        fun lid  ->
          fun fields  ->
                                     ...
                                     (let uu____11036 =
                                        let uu____11037 =
                                          FStar_ToSyntax_Env.current_module
                                            env in
                                        uu____11037.FStar_Ident.str in
                                 ...
                                 let quals q =
                                   ...
                                   then
                                     let uu____11051 =
                                       FStar_List.filter
                                         (fun uu___222_11055  ->
                                            match uu___222_11055 with
                                            | FStar_Syntax_Syntax.Abstract 
                                                -> false
                                            | uu____11056 -> true) q in
            ...
            FStar_All.pipe_right uu____10983 FStar_List.flatten
    ...
    fun env  ->
      fun se  ->
        ...
        | FStar_Syntax_Syntax.Sig_datacon
            (lid,uu____11149,t,uu____11151,n1,uu____11153) when
            Prims.op_Negation
              (FStar_Ident.lid_equals lid FStar_Parser_Const.lexcons_lid)
            ->
            let uu____11158 = FStar_Syntax_Util.arrow_formals t in
            (match uu____11158 with
             | (formals,uu____11174) ->
                 (match formals with
                  | [] -> []
                  | uu____11197 ->
                      let filter_records uu___224_11209 =
                        match uu___224_11209 with
                        | FStar_Syntax_Syntax.RecordConstructor
                            (uu____11212,fns) ->
                            FStar_Pervasives_Native.Some
                              (FStar_Syntax_Syntax.Record_ctor (lid, fns))
                        | uu____11224 -> FStar_Pervasives_Native.None in
                      let fv_qual =
                        let uu____11226 =
                      ...
                      let uu____11236 = FStar_Util.first_N n1 formals in
                ...
                fun rng  ->
                  let dd =
                    ...
                    then
                      ...
                      FStar_Syntax_Syntax.Delta_abstract uu____11346
                  ...
                  let lb =
                    ...
                    let uu____11355 =
                      let uu____11358 = FStar_Syntax_Syntax.mk_Total k in
                      FStar_Syntax_Util.arrow typars uu____11358 in
                    let uu____11361 = no_annot_abs typars t in
                    {
                      FStar_Syntax_Syntax.lbname = uu____11349;
                      FStar_Syntax_Syntax.lbunivs = uvs;
                      FStar_Syntax_Syntax.lbtyp = uu____11355;
                      FStar_Syntax_Syntax.lbeff =
                        FStar_Parser_Const.effect_Tot_lid;
                      FStar_Syntax_Syntax.lbdef = uu____11361
                    } in
                  {
                    FStar_Syntax_Syntax.sigel =
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___225_11410 =
            match uu___225_11410 with
            | FStar_Parser_AST.TyconAbstract (id,uu____11412,uu____11413) ->
                id
            | FStar_Parser_AST.TyconAbbrev
                (id,uu____11423,uu____11424,uu____11425) -> id
            | FStar_Parser_AST.TyconRecord
                (id,uu____11435,uu____11436,uu____11437) -> id
            | FStar_Parser_AST.TyconVariant
                (id,uu____11467,uu____11468,uu____11469) -> id in
          let binder_to_term b =
            match b.FStar_Parser_AST.b with
            | FStar_Parser_AST.Annotated (x,uu____11511) ->
                let uu____11512 =
                  let uu____11513 = FStar_Ident.lid_of_ids [x] in
                  FStar_Parser_AST.Var uu____11513 in
                FStar_Parser_AST.mk_term uu____11512 x.FStar_Ident.idRange
                  FStar_Parser_AST.Expr
            | FStar_Parser_AST.Variable x ->
                let uu____11515 =
                  let uu____11516 = FStar_Ident.lid_of_ids [x] in
                  FStar_Parser_AST.Var uu____11516 in
                FStar_Parser_AST.mk_term uu____11515 x.FStar_Ident.idRange
                  FStar_Parser_AST.Expr
            | FStar_Parser_AST.TAnnotated (a,uu____11518) ->
          ...
          let apply_binders t binders =
            let imp_of_aqual b =
              ...
              | FStar_Pervasives_Native.Some (FStar_Parser_AST.Implicit ) ->
                  FStar_Parser_AST.Hash
              | uu____11541 -> FStar_Parser_AST.Nothing in
            FStar_List.fold_left
              (fun out  ->
                 fun b  ->
                   let uu____11547 =
                     let uu____11548 =
                       let uu____11555 = binder_to_term b in
                       (out, uu____11555, (imp_of_aqual b)) in
                     FStar_Parser_AST.App uu____11548 in
                   FStar_Parser_AST.mk_term uu____11547
                     out.FStar_Parser_AST.range out.FStar_Parser_AST.level) t
              binders in
          let tycon_record_as_variant uu___226_11565 =
            match uu___226_11565 with
            | FStar_Parser_AST.TyconRecord (id,parms,kopt,fields) ->
                ...
                let result =
                  let uu____11637 =
                    let uu____11638 =
                      let uu____11639 = FStar_Ident.lid_of_ids [id] in
                      FStar_Parser_AST.Var uu____11639 in
                    FStar_Parser_AST.mk_term uu____11638
                      id.FStar_Ident.idRange FStar_Parser_AST.Type_level in
                  apply_binders uu____11637 parms in
                let constrTyp =
                  FStar_Parser_AST.mk_term
                ...
                ((FStar_Parser_AST.TyconVariant
                    (id, parms, kopt,
                      [(constrName, (FStar_Pervasives_Native.Some constrTyp),
                         FStar_Pervasives_Native.None, false)])),
                  uu____11643)
            | uu____11734 -> failwith "impossible" in
          let desugar_abstract_tc quals1 _env mutuals uu___227_11765 =
            match uu___227_11765 with
            | FStar_Parser_AST.TyconAbstract (id,binders,kopt) ->
                let uu____11789 = typars_of_binders _env binders in
                (match uu____11789 with
                 | (_env',typars) ->
                     ...
                     let tconstr =
                       let uu____11835 =
                         let uu____11836 =
                           let uu____11837 = FStar_Ident.lid_of_ids [id] in
                           FStar_Parser_AST.Var uu____11837 in
                         FStar_Parser_AST.mk_term uu____11836
                           id.FStar_Ident.idRange FStar_Parser_AST.Type_level in
                       apply_binders uu____11835 binders in
            ...
            | uu____11850 -> failwith "Unexpected tycon" in
          let push_tparams env1 bs =
            let uu____11894 =
              FStar_List.fold_left
                (fun uu____11934  ->
                   fun uu____11935  ->
                     match (uu____11934, uu____11935) with
                     | ((env2,tps),(x,imp)) ->
                         let uu____12026 =
          ...
          | (FStar_Parser_AST.TyconAbstract (id,bs,kopt))::[] ->
              let kopt1 =
                match kopt with
                | FStar_Pervasives_Native.None  ->
                    let uu____12139 = tm_type_z id.FStar_Ident.idRange in
                    FStar_Pervasives_Native.Some uu____12139
                | uu____12140 -> kopt in
              let tc = FStar_Parser_AST.TyconAbstract (id, bs, kopt1) in
              let uu____12148 = desugar_abstract_tc quals env [] tc in
              (match uu____12148 with
               | (uu____12161,uu____12162,se,uu____12164) ->
                   let se1 =
                     match se.FStar_Syntax_Syntax.sigel with
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         (l,uu____12167,typars,k,[],[]) ->
                         ...
                         let quals2 =
                           ...
                           then quals1
                             ...
                             ((let uu____12184 =
                                 let uu____12185 = FStar_Options.ml_ish () in
                                 Prims.op_Negation uu____12185 in
                               if uu____12184
                               then
                                 let uu____12186 =
                                   let uu____12187 =
                                   ...
                                   FStar_Util.format1
                                     ...
                                     uu____12187 in
                                 FStar_Errors.warn
                                   se.FStar_Syntax_Syntax.sigrng uu____12186
                               else ());
                              FStar_Syntax_Syntax.Assumption
                              ::
                               ...
                               let uu____12195 =
                                 let uu____12198 =
                                   let uu____12199 =
                                     ...
                                     (typars, uu____12212) in
                                   FStar_Syntax_Syntax.Tm_arrow uu____12199 in
                                 FStar_Syntax_Syntax.mk uu____12198 in
                               uu____12195 FStar_Pervasives_Native.None
                                 se.FStar_Syntax_Syntax.sigrng in
                         let uu___254_12216 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, [], t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___254_12216.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals = quals2;
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___254_12216.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___254_12216.FStar_Syntax_Syntax.sigattrs)
                         }
                     | uu____12219 -> failwith "Impossible" in
                   let env1 = FStar_ToSyntax_Env.push_sigelt env se1 in
                   let env2 =
                     let uu____12222 = FStar_ToSyntax_Env.qualify env1 id in
                     FStar_ToSyntax_Env.push_doc env1 uu____12222
                       d.FStar_Parser_AST.doc in
                   (env2, [se1]))
          | (FStar_Parser_AST.TyconAbbrev (id,binders,kopt,t))::[] ->
              let uu____12237 = typars_of_binders env binders in
               ...
               | (env',typars) ->
                   let k =
                     ...
                     | FStar_Pervasives_Native.None  ->
                         let uu____12273 =
                           FStar_Util.for_some
                             (fun uu___228_12275  ->
                                match uu___228_12275 with
                                | FStar_Syntax_Syntax.Effect  -> true
                                | uu____12276 -> false) quals in
                         if uu____12273
                   ...
                   let quals1 =
                     let uu____12283 =
                       FStar_All.pipe_right quals
                         (FStar_Util.for_some
                            (fun uu___229_12287  ->
                               match uu___229_12287 with
                               | FStar_Syntax_Syntax.Logic  -> true
                               | uu____12288 -> false)) in
                     if uu____12283
                     then quals
                     else
                       if
                   ...
                   let se =
                     ...
                     then
                       let uu____12300 =
                         let uu____12307 =
                           let uu____12308 = unparen t in
                           uu____12308.FStar_Parser_AST.tm in
                         match uu____12307 with
                         | FStar_Parser_AST.Construct (head1,args) ->
                             let uu____12329 =
                               match FStar_List.rev args with
                               | (last_arg,uu____12359)::args_rev ->
                                   let uu____12371 =
                                     let uu____12372 = unparen last_arg in
                                     uu____12372.FStar_Parser_AST.tm in
                              ...
                              | (cattributes,args1) ->
                                  ...
                                  ((FStar_Parser_AST.mk_term
                                      (FStar_Parser_AST.Construct
                                         (head1, args1))
                                      t.FStar_Parser_AST.range
                                      t.FStar_Parser_AST.level), uu____12448))
                         | uu____12459 -> (t, []) in
                   ...
                   let env2 =
                     FStar_ToSyntax_Env.push_doc env1 qlid
                       d.FStar_Parser_AST.doc in
                   (env2, [se]))
          | (FStar_Parser_AST.TyconRecord uu____12493)::[] ->
              let trec = FStar_List.hd tcs in
              let uu____12517 = tycon_record_as_variant trec in
                     ...
                     let uu____12537 =
                       let uu____12538 =
                         let uu____12547 =
                           let uu____12550 =
                             FStar_ToSyntax_Env.current_module env in
                           FStar_Ident.ids_of_lid uu____12550 in
                         (uu____12547, fs) in
                       FStar_Syntax_Syntax.RecordType uu____12538 in
                     uu____12537 :: quals in
                   desugar_tycon env d uu____12534 [t])
          | uu____12555::uu____12556 ->
              ...
              let rec collect_tcs quals1 et tc =
                let uu____12717 = et in
                match uu____12717 with
                | (env1,tcs1) ->
                    (match tc with
                     | FStar_Parser_AST.TyconRecord uu____12942 ->
                         let trec = tc in
                         let uu____12966 = tycon_record_as_variant trec in
                                  ...
                                  let uu____13029 =
                                    let uu____13038 =
                                      let uu____13041 =
                                        FStar_ToSyntax_Env.current_module
                                          env1 in
                                      FStar_Ident.ids_of_lid uu____13041 in
                                    (uu____13038, fs) in
                                  FStar_Syntax_Syntax.RecordType uu____13029 in
                                uu____13028 :: quals1 in
                              collect_tcs uu____13025 (env1, tcs1) t)
                     | FStar_Parser_AST.TyconVariant
               ...
               | (env1,tcs1) ->
                   ...
                   let docs_tps_sigelts =
                     FStar_All.pipe_right tcs2
                       (FStar_List.collect
                          (fun uu___232_14080  ->
                             match uu___232_14080 with
                             | FStar_Util.Inr
                                 ({
                                    FStar_Syntax_Syntax.sigel =
                                      FStar_Syntax_Syntax.Sig_inductive_typ
                                      (id,uvs,tpars,k,uu____14147,uu____14148);
                                    FStar_Syntax_Syntax.sigrng = uu____14149;
                                    FStar_Syntax_Syntax.sigquals =
                                      uu____14150;
                                    FStar_Syntax_Syntax.sigmeta = uu____14151;
                                    FStar_Syntax_Syntax.sigattrs =
                                      uu____14152;_},binders,t,quals1)
                                 ->
                                 let t1 =
                                   let uu____14213 =
                             ...
                             | FStar_Util.Inl
                                 ({
                                    FStar_Syntax_Syntax.sigel =
                                      FStar_Syntax_Syntax.Sig_inductive_typ
                                      (tname,univs1,tpars,k,mutuals1,uu____14366);
                                    FStar_Syntax_Syntax.sigrng = uu____14367;
                                    FStar_Syntax_Syntax.sigquals =
                                      tname_quals;
                                    FStar_Syntax_Syntax.sigmeta = uu____14369;
                                    FStar_Syntax_Syntax.sigattrs =
                                      uu____14370;_},constrs,tconstr,quals1)
                                 ->
                                 let mk_tot t =
                                   let tot1 =
                                     FStar_Parser_AST.mk_term
                                 ...
                                 let uu____14466 = push_tparams env1 tpars in
                                  ...
                                  | (env_tps,tps) ->
                                      ...
                                      (match uu____14565 with
                                       | (constrNames,constrs1) ->
                                           ...
                                           :: constrs1))
                             | uu____15078 -> failwith "impossible")) in
                   let name_docs =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____15210  ->
                             match uu____15210 with
                             | (name_doc,uu____15238,uu____15239) -> name_doc)) in
                   let sigelts =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____15319  ->
                             match uu____15319 with
                             | (uu____15340,uu____15341,se) -> se)) in
                   let uu____15371 =
                     let uu____15378 =
                       FStar_List.collect FStar_Syntax_Util.lids_of_sigelt
                         sigelts in
                     FStar_Syntax_MutRecTy.disentangle_abbrevs_from_bundle
                       sigelts quals uu____15378 rng in
                          ...
                          FStar_All.pipe_right sigelts
                            (FStar_List.collect
                               (fun se  ->
                                  match se.FStar_Syntax_Syntax.sigel with
                                  | FStar_Syntax_Syntax.Sig_inductive_typ
                                      (tname,uu____15518,tps,k,uu____15521,constrs)
                                      when
        ...
        FStar_List.fold_left
          (fun uu____15617  ->
             fun b  ->
               ...
               | (env1,binders1) ->
                   let uu____15637 = desugar_binder env1 b in
          ...
          fun eff_binders  ->
            fun eff_typ  ->
              fun eff_decls  ->
                ...
                let uu____15789 = desugar_binders monad_env eff_binders in
                ...
                | (env1,binders) ->
                    ...
                    let for_free =
                      let uu____15810 =
                        let uu____15811 =
                          ...
                          FStar_Pervasives_Native.fst uu____15818 in
                        FStar_List.length uu____15811 in
                      uu____15810 = (Prims.parse_int "1") in
                    ...
                    let name_of_eff_decl decl =
                      ...
                      | FStar_Parser_AST.Tycon
                          (uu____15860,(FStar_Parser_AST.TyconAbbrev
                                        (name,uu____15862,uu____15863,uu____15864),uu____15865)::[])
                    ...
                    let uu____15899 =
                      FStar_List.partition
                        (fun decl  ->
                           let uu____15911 = name_of_eff_decl decl in
                           FStar_List.mem uu____15911 mandatory_members)
                        eff_decls in
                                ...
                                FStar_All.pipe_right actions
                                  (FStar_List.map
                                     (fun d1  ->
                                        ...
                                        | FStar_Parser_AST.Tycon
                                            (uu____16061,(FStar_Parser_AST.TyconAbbrev
                                                          (name,action_params,uu____16064,
                                                           {
                                                             FStar_Parser_AST.tm
                                                               =
                                                               FStar_Parser_AST.Construct
                                        ...
                                        | FStar_Parser_AST.Tycon
                                            (uu____16159,(FStar_Parser_AST.TyconAbbrev
                                                          (name,action_params,uu____16162,defn),doc1)::[])
                                            when for_free ->
                                            let uu____16197 =
                                              desugar_binders env2
                                                action_params in
                              ...
                              let se =
                                ...
                                then
                                  ...
                                  let uu____16282 =
                                    let uu____16283 =
                                      let uu____16284 =
                                        let uu____16285 = lookup "repr" in
                                        FStar_Pervasives_Native.snd
                                          uu____16285 in
                                      let uu____16294 = lookup "return" in
                                      let uu____16295 = lookup "bind" in
                                      {
                                    ...
                                    FStar_Syntax_Syntax.Sig_new_effect_for_free
                                      uu____16283 in
                                  {
                                    FStar_Syntax_Syntax.sigel = uu____16282;
                                    FStar_Syntax_Syntax.sigrng =
                                  ...
                                  (let rr =
                                     FStar_Util.for_some
                                       (fun uu___233_16299  ->
                                          match uu___233_16299 with
                                          | FStar_Syntax_Syntax.Reifiable  ->
                                              true
                                          | FStar_Syntax_Syntax.Reflectable
                                              uu____16300 -> true
                                          | uu____16301 -> false) qualifiers in
                                   let un_ts = ([], FStar_Syntax_Syntax.tun) in
                                   let uu____16311 =
                                     let uu____16312 =
                                       let uu____16313 = lookup "return_wp" in
                                       let uu____16314 = lookup "bind_wp" in
                                       let uu____16315 =
                                         lookup "if_then_else" in
                                       let uu____16316 = lookup "ite_wp" in
                                       let uu____16317 = lookup "stronger" in
                                       let uu____16318 = lookup "close_wp" in
                                       let uu____16319 = lookup "assert_p" in
                                       let uu____16320 = lookup "assume_p" in
                                       let uu____16321 = lookup "null_wp" in
                                       let uu____16322 = lookup "trivial" in
                                       let uu____16323 =
                                         if rr
                                         then
                                           let uu____16324 = lookup "repr" in
                                           FStar_All.pipe_left
                                             FStar_Pervasives_Native.snd
                                             uu____16324
                                     ...
                                     FStar_Syntax_Syntax.Sig_new_effect
                                       uu____16312 in
                                   {
                                     FStar_Syntax_Syntax.sigel = uu____16311;
                                     FStar_Syntax_Syntax.sigrng =
                                       (d.FStar_Parser_AST.drange);
                                     FStar_Syntax_Syntax.sigquals =
                                       qualifiers;
          ...
          fun eff_name  ->
            fun eff_binders  ->
              fun defn  ->
                ...
                let uu____16414 = desugar_binders env1 eff_binders in
                match uu____16414 with
                | (env2,binders) ->
                    let uu____16433 =
                      let uu____16452 = head_and_args defn in
                      ...
                      | (head1,args) ->
                                      ...
                                      let uu____16505 =
                                        let uu____16506 =
                                          FStar_Parser_AST.term_to_string
                                            head1 in
                                        Prims.strcat uu____16506 " not found" in
                                      Prims.strcat "Effect " uu____16505 in
                                    (uu____16504,
                                      (d.FStar_Parser_AST.drange)) in
                                  FStar_Errors.Error uu____16499 in
                                FStar_Exn.raise uu____16498 in
                          let ed =
                            FStar_ToSyntax_Env.fail_or env2
                          ...
                          let uu____16508 =
                            match FStar_List.rev args with
                            | (last_arg,uu____16538)::args_rev ->
                                let uu____16550 =
                                  let uu____16551 = unparen last_arg in
                                  uu____16551.FStar_Parser_AST.tm in
                          ...
                          (match uu____16508 with
                           | (cattributes,args1) ->
                               let uu____16639 = desugar_args env2 args1 in
                               let uu____16648 =
                                 desugar_attributes env2 cattributes in
                               (lid, ed, uu____16639, uu____16648)) in
                    (match uu____16433 with
                     | (ed_lid,ed,args,cattributes) ->
                         let binders1 =
                           FStar_Syntax_Subst.close_binders binders in
                         let sub1 uu____16707 =
                         ...
                         let ed1 =
                           let uu____16758 =
                             ...
                             FStar_Pervasives_Native.snd uu____16759 in
                           let uu____16770 =
                           ...
                           let uu____16780 =
                             ...
                             FStar_Pervasives_Native.snd uu____16781 in
                           let uu____16792 =
                             ...
                             FStar_List.map
                               (fun action  ->
                                  ...
                                  let uu____16803 =
                                    ...
                                    FStar_Pervasives_Native.snd uu____16804 in
                                  let uu____16815 =
                                    let uu____16816 =
                                      sub1
                                        ([],
                                          (action.FStar_Syntax_Syntax.action_typ)) in
                                    FStar_Pervasives_Native.snd uu____16816 in
                                  {
                                    FStar_Syntax_Syntax.action_name =
                                      uu____16802;
                                    FStar_Syntax_Syntax.action_unqualified_name
                                  ...
                                  }) ed.FStar_Syntax_Syntax.actions in
                           {
                             ...
                             FStar_Syntax_Syntax.signature = uu____16758;
                             FStar_Syntax_Syntax.ret_wp = uu____16770;
                             FStar_Syntax_Syntax.bind_wp = uu____16771;
                             FStar_Syntax_Syntax.if_then_else = uu____16772;
                             FStar_Syntax_Syntax.ite_wp = uu____16773;
                             FStar_Syntax_Syntax.stronger = uu____16774;
                             FStar_Syntax_Syntax.close_wp = uu____16775;
                             FStar_Syntax_Syntax.assert_p = uu____16776;
                             FStar_Syntax_Syntax.assume_p = uu____16777;
                             FStar_Syntax_Syntax.null_wp = uu____16778;
                             FStar_Syntax_Syntax.trivial = uu____16779;
                             FStar_Syntax_Syntax.repr = uu____16780;
                             FStar_Syntax_Syntax.return_repr = uu____16792;
                             FStar_Syntax_Syntax.bind_repr = uu____16793;
                             FStar_Syntax_Syntax.actions = uu____16794
                           } in
                         let se =
                           let for_free =
                             let uu____16829 =
                               let uu____16830 =
                                 ...
                                 FStar_Pervasives_Native.fst uu____16837 in
                               FStar_List.length uu____16830 in
                             uu____16829 = (Prims.parse_int "1") in
                           let uu____16866 =
                             let uu____16869 =
                               trans_qual1
                                 (FStar_Pervasives_Native.Some mname) in
                             FStar_List.map uu____16869 quals in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (if for_free
                                then
  ...
  fun d  ->
    ...
    | (text,kv) ->
        ...
        let pp =
          ...
          | FStar_Pervasives_Native.Some uu____16957 ->
              let uu____16958 =
                let uu____16959 =
        ...
        let fv =
          let uu____16991 = FStar_Ident.lid_of_str "FStar.Pervasives.Comment" in
          FStar_Syntax_Syntax.fvar uu____16991
            FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None in
        let arg = FStar_Syntax_Util.exp_string str in
        let uu____16993 =
          let uu____17002 = FStar_Syntax_Syntax.as_arg arg in [uu____17002] in
        FStar_Syntax_Util.mk_app fv uu____16993
and desugar_decl:
  env_t ->
    FStar_Parser_AST.decl ->
      (env_t,FStar_Syntax_Syntax.sigelts) FStar_Pervasives_Native.tuple2
  ...
  fun env  ->
    fun d  ->
      let uu____17009 = desugar_decl_noattrs env d in
      match uu____17009 with
      | (env1,sigelts) ->
          let attrs = d.FStar_Parser_AST.attrs in
          let attrs1 = FStar_List.map (desugar_term env1) attrs in
          let attrs2 =
            let uu____17029 = mk_comment_attr d in uu____17029 :: attrs1 in
          let uu____17034 =
            FStar_List.map
              (fun sigelt  ->
                 let uu___255_17040 = sigelt in
                 {
                   FStar_Syntax_Syntax.sigel =
                     (uu___255_17040.FStar_Syntax_Syntax.sigel);
                   FStar_Syntax_Syntax.sigrng =
                     (uu___255_17040.FStar_Syntax_Syntax.sigrng);
                   FStar_Syntax_Syntax.sigquals =
                     (uu___255_17040.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___255_17040.FStar_Syntax_Syntax.sigmeta);
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Pragma p ->
          ...
          (if p = FStar_Parser_AST.LightOff
           ...
           (env, [se]))
      | FStar_Parser_AST.Fsdoc uu____17066 -> (env, [])
      ...
      | FStar_Parser_AST.ModuleAbbrev (x,l) ->
          let uu____17082 = FStar_ToSyntax_Env.push_module_abbrev env x l in
          (uu____17082, [])
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          ...
          let tcs1 =
            FStar_List.map
              (fun uu____17121  ->
                 match uu____17121 with | (x,uu____17129) -> x) tcs in
          let uu____17134 =
            FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals in
          desugar_tycon env d uu____17134 tcs1
      | FStar_Parser_AST.TopLevelLet (isrec,lets) ->
          ...
          let expand_toplevel_pattern =
            (isrec = FStar_Parser_AST.NoLetQualifier) &&
              (match lets with
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatOp uu____17156;
                    FStar_Parser_AST.prange = uu____17157;_},uu____17158)::[]
                   -> false
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                      uu____17167;
                    FStar_Parser_AST.prange = uu____17168;_},uu____17169)::[]
                   -> false
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed
                      ({
                         FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                           uu____17184;
                         FStar_Parser_AST.prange = uu____17185;_},uu____17186);
                    FStar_Parser_AST.prange = uu____17187;_},uu____17188)::[]
                   -> false
               | (p,uu____17204)::[] ->
                   let uu____17213 = is_app_pattern p in
                   Prims.op_Negation uu____17213
               | uu____17214 -> false) in
          ...
          then
            ...
            let uu____17233 =
              ...
              uu____17234.FStar_Syntax_Syntax.n in
            (match uu____17233 with
             | FStar_Syntax_Syntax.Tm_let (lbs,uu____17242) ->
                 let fvs =
                 ...
                 let quals1 =
                   ...
                   | uu____17279 ->
                       FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                         (FStar_List.collect
                            (fun uu___234_17292  ->
                               match uu___234_17292 with
                               | {
                                   FStar_Syntax_Syntax.lbname =
                                     FStar_Util.Inl uu____17295;
                                   FStar_Syntax_Syntax.lbunivs = uu____17296;
                                   FStar_Syntax_Syntax.lbtyp = uu____17297;
                                   FStar_Syntax_Syntax.lbeff = uu____17298;
                                   FStar_Syntax_Syntax.lbdef = uu____17299;_}
                                   -> []
                               | {
                                   FStar_Syntax_Syntax.lbname =
                                     FStar_Util.Inr fv;
                                   FStar_Syntax_Syntax.lbunivs = uu____17307;
                                   FStar_Syntax_Syntax.lbtyp = uu____17308;
                                   FStar_Syntax_Syntax.lbeff = uu____17309;
                                   FStar_Syntax_Syntax.lbdef = uu____17310;_}
                                   ->
                       ...
                       FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___256_17374 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___257_17376 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___257_17376.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___257_17376.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___256_17374.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___256_17374.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___256_17374.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___256_17374.FStar_Syntax_Syntax.lbdef)
                               })) in
                     ((FStar_Pervasives_Native.fst lbs), uu____17360)
                   else lbs in
                 let names1 =
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___258_17457 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___258_17457.FStar_Parser_AST.prange)
                       }
                   | uu____17458 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___259_17465 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___259_17465.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___259_17465.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___259_17465.FStar_Parser_AST.attrs)
                      }) in
                 let build_projection uu____17497 id =
                   ...
                   | (env1,ses) ->
                       let main =
                         let uu____17518 =
                           ...
                           FStar_Parser_AST.Var uu____17519 in
                         FStar_Parser_AST.mk_term uu____17518
                       ...
                       let uu____17569 = desugar_decl env1 id_decl in
                       (match uu____17569 with
                        | (env2,ses') -> (env2, (FStar_List.append ses ses'))) in
                 let bvs =
                   let uu____17587 = gather_pattern_bound_vars pat in
                   FStar_All.pipe_right uu____17587 FStar_Util.set_elements in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals in
          let t1 =
            let uu____17618 = close_fun env t in desugar_term env uu____17618 in
          let quals1 =
            let uu____17622 =
          ...
          let se =
                ...
                quals1 in
            {
              ...
              FStar_Syntax_Syntax.sigrng = (d.FStar_Parser_AST.drange);
              FStar_Syntax_Syntax.sigquals = uu____17628;
              FStar_Syntax_Syntax.sigmeta =
                FStar_Syntax_Syntax.default_sigmeta;
              FStar_Syntax_Syntax.sigattrs = []
            } in
      ...
      | FStar_Parser_AST.Exception (id,FStar_Pervasives_Native.Some term) ->
          ...
          let t1 =
            let uu____17688 =
              let uu____17695 = FStar_Syntax_Syntax.null_binder t in
              [uu____17695] in
            let uu____17696 =
              let uu____17699 =
                let uu____17700 =
                  FStar_ToSyntax_Env.fail_or env
                    (FStar_ToSyntax_Env.try_lookup_lid env)
                    FStar_Parser_Const.exn_lid in
                FStar_Pervasives_Native.fst uu____17700 in
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____17699 in
            FStar_Syntax_Util.arrow uu____17688 uu____17696 in
          let l = FStar_ToSyntax_Env.qualify env id in
          let qual1 = [FStar_Syntax_Syntax.ExceptionConstructor] in
          let se =
            {
      ...
      | FStar_Parser_AST.SubEffect l ->
            ...
            | FStar_Pervasives_Native.None  ->
                let uu____17765 =
                  let uu____17766 =
                    let uu____17771 =
                      let uu____17772 =
                        let uu____17773 = FStar_Syntax_Print.lid_to_string l1 in
                        Prims.strcat uu____17773 " not found" in
                      Prims.strcat "Effect name " uu____17772 in
                    (uu____17771, (d.FStar_Parser_AST.drange)) in
                  FStar_Errors.Error uu____17766 in
                FStar_Exn.raise uu____17765
          ...
          let uu____17777 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____17819 =
                  let uu____17828 =
                    let uu____17835 = desugar_term env t in ([], uu____17835) in
                  FStar_Pervasives_Native.Some uu____17828 in
                (uu____17819, FStar_Pervasives_Native.None)
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                let uu____17868 =
                  let uu____17877 =
                    let uu____17884 = desugar_term env wp in
                    ([], uu____17884) in
                  FStar_Pervasives_Native.Some uu____17877 in
                let uu____17893 =
                  let uu____17902 =
                    let uu____17909 = desugar_term env t in ([], uu____17909) in
                  FStar_Pervasives_Native.Some uu____17902 in
                (uu____17868, uu____17893)
            | FStar_Parser_AST.LiftForFree t ->
                let uu____17935 =
                  let uu____17944 =
                    let uu____17951 = desugar_term env t in ([], uu____17951) in
                  FStar_Pervasives_Native.Some uu____17944 in
                (FStar_Pervasives_Native.None, uu____17935) in
        ...
        FStar_List.fold_left
          (fun uu____18061  ->
             fun d  ->
               ...
               | (env1,sigelts) ->
                   let uu____18081 = desugar_decl env1 d in
                   (match uu____18081 with
                    | (env2,se) -> (env2, (FStar_List.append sigelts se))))
          (env, []) decls in
      match uu____18041 with
      | (env1,sigelts) ->
          let rec forward acc uu___236_18122 =
            match uu___236_18122 with
            | se1::se2::sigelts1 ->
                (match ((se1.FStar_Syntax_Syntax.sigel),
                         (se2.FStar_Syntax_Syntax.sigel))
                 with
                 | (FStar_Syntax_Syntax.Sig_declare_typ
                    uu____18136,FStar_Syntax_Syntax.Sig_let uu____18137) ->
                     let uu____18150 =
                       let uu____18153 =
                         let uu___260_18154 = se2 in
                         let uu____18155 =
                           let uu____18158 =
                             FStar_List.filter
                               (fun uu___235_18172  ->
                                  match uu___235_18172 with
                                  | {
                                      FStar_Syntax_Syntax.n =
                                        FStar_Syntax_Syntax.Tm_app
                                        ({
                                           ...
                                           FStar_Syntax_Syntax.pos =
                                             uu____18176;
                                           FStar_Syntax_Syntax.vars =
                                             uu____18177;_},uu____18178);
                                      FStar_Syntax_Syntax.pos = uu____18179;
                                      FStar_Syntax_Syntax.vars = uu____18180;_}
                                      when
                                      let uu____18203 =
                                        let uu____18204 =
                                          FStar_Syntax_Syntax.lid_of_fv fv in
                                        FStar_Ident.string_of_lid uu____18204 in
                                      uu____18203 =
                                        "FStar.Pervasives.Comment"
                                      -> true
                                  | uu____18205 -> false)
                               se1.FStar_Syntax_Syntax.sigattrs in
                           FStar_List.append uu____18158
                             se2.FStar_Syntax_Syntax.sigattrs in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (uu___260_18154.FStar_Syntax_Syntax.sigel);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___260_18154.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___260_18154.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___260_18154.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs = uu____18155
                         } in
                       uu____18153 :: se1 :: acc in
                     forward uu____18150 sigelts1
                 | uu____18210 -> forward (se1 :: acc) (se2 :: sigelts1))
            | sigelts1 -> FStar_List.rev_append acc sigelts1 in
          let uu____18218 = forward [] sigelts in (env1, uu____18218)
let open_prims_all:
  ...
  fun curmod  ->
    fun env  ->
      fun m  ->
        let env1 =
          match (curmod, m) with
          | (FStar_Pervasives_Native.None ,uu____18272) -> env
          | (FStar_Pervasives_Native.Some
             { FStar_Syntax_Syntax.name = prev_lid;
               FStar_Syntax_Syntax.declarations = uu____18276;
               FStar_Syntax_Syntax.exports = uu____18277;
               FStar_Syntax_Syntax.is_interface = uu____18278;_},FStar_Parser_AST.Module
             (current_lid,uu____18280)) when
              (FStar_Ident.lid_equals prev_lid current_lid) &&
                (FStar_Options.interactive ())
              -> env
          | (FStar_Pervasives_Native.Some prev_mod,uu____18288) ->
        ...
        let uu____18291 =
          ...
          | FStar_Parser_AST.Interface (mname,decls,admitted) ->
              ...
              (uu____18327, mname, decls, true)
          | FStar_Parser_AST.Module (mname,decls) ->
              let uu____18344 =
                FStar_ToSyntax_Env.prepare_module_or_interface false false
                  env1 mname FStar_ToSyntax_Env.default_mii in
              (uu____18344, mname, decls, false) in
        match uu____18291 with
        | ((env2,pop_when_done),mname,decls,intf) ->
            let uu____18374 = desugar_decls env2 decls in
        ...
        let m1 =
          let uu____18432 =
            (FStar_Options.interactive ()) &&
              (let uu____18434 =
                 let uu____18435 =
                   let uu____18436 = FStar_Options.file_list () in
                   FStar_List.hd uu____18436 in
                 FStar_Util.get_file_extension uu____18435 in
               FStar_List.mem uu____18434 ["fsti"; "fsi"]) in
          if uu____18432 then as_interface m else m in
        let uu____18440 = desugar_modul_common curmod env m1 in
        match uu____18440 with
        | (x,y,pop_when_done) ->
            (if pop_when_done
             then (let uu____18455 = FStar_ToSyntax_Env.pop () in ())
             else ();
             (x, y))
let desugar_modul:
  FStar_ToSyntax_Env.env ->
    ...
    fun m  ->
      ...
      | (env1,modul,pop_when_done) ->
          ...
          ((let uu____18489 =
            ...
            if uu____18489
            then
              let uu____18490 = FStar_Syntax_Print.modul_to_string modul in
              FStar_Util.print1 "%s\n" uu____18490
            else ());
           (let uu____18492 =
              if pop_when_done
...
let ast_modul_to_modul:
  ...
  fun modul  ->
    fun env  ->
      let uu____18507 = desugar_modul env modul in
      match uu____18507 with | (env1,modul1) -> (modul1, env1)
let decls_to_sigelts:
  ...
  fun decls  ->
    fun env  ->
      let uu____18535 = desugar_decls env decls in
      match uu____18535 with | (env1,sigelts) -> (sigelts, env1)
let partial_ast_modul_to_modul:
  ...
  fun modul  ->
    fun a_modul  ->
      fun env  ->
        let uu____18575 = desugar_partial_modul modul env a_modul in
        match uu____18575 with | (env1,modul1) -> (modul1, env1)
      ...
      fun en  ->
        ...
        | (en1,pop_when_done) ->
            let en2 =
              ...
              FStar_List.fold_left FStar_ToSyntax_Env.push_sigelt uu____18615
