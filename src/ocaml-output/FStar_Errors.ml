          ...
          let uu____309 =
            ...
            then ""
              ...
              (let uu____314 = FStar_Range.string_of_range r  in
               FStar_Util.format1 " (see also %s)" uu____314)
             in
          (uu____307, uu____309)
       in
...
let report_all : Prims.unit -> issue Prims.list =
  fun uu____922  ->
    let uu____923 =
      let uu____928 = FStar_ST.op_Bang current_handler  in
      uu____928.eh_report  in
    uu____923 ()
  
let clear : Prims.unit -> Prims.unit =
  fun uu____978  ->
    let uu____979 =
      let uu____982 = FStar_ST.op_Bang current_handler  in uu____982.eh_clear
       in
    uu____979 ()
  ...
  fun uu___62_1442  ->
    ...
    | FStar_Util.NYI msg ->
        let uu____1450 =
          ...
          mk_issue ENotImplemented FStar_Pervasives_Native.None uu____1451
           in
