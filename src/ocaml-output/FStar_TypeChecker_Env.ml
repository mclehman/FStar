      ...
      fun universe_of  ->
        fun solver  ->
          fun module_lid  ->
            ...
            let uu____5142 =
              FStar_Util.mk_ref FStar_TypeChecker_Common.id_info_table_empty
               in
          ...
          FStar_All.pipe_right qix
            (FStar_List.tryFind
               (fun uu____6384  ->
                  ...
                  | (m,uu____6390) -> FStar_Ident.lid_equals l m))
           in
...
let inst_tscheme :
  ...
  fun uu___130_6990  ->
    ...
    | (us,t) ->
        let us' =
          FStar_All.pipe_right us
            (FStar_List.map (fun uu____7014  -> new_u_univ ()))
           in
             ...
             | FStar_Util.Inr se ->
                 ...
                 FStar_All.pipe_right uu____8803
                   (FStar_Util.map_option
                      (fun uu____8891  ->
                         match uu____8891 with | (us_t,rng1) -> (us_t, rng1))))
         in
      let uu____8922 =
  ...
  fun env  ->
    fun bv  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____9157 =
            let uu____9158 =
              let uu____9163 = variable_not_found bv  in (uu____9163, bvr)
               in
                 ...
                 then univ_insts
                   ...
                   (let uu____10545 =
                      ...
                      FStar_Util.format3
                        ...
                        uu____10546 uu____10548 uu____10549
                       in
                    failwith uu____10545)
                  in
      ...
      let mapper x =
        ...
        | FStar_Util.Inr (se,uu____11524) ->
            (match se.FStar_Syntax_Syntax.sigel with
             ...
             | uu____11565 -> FStar_Pervasives_Native.Some false)
         in
      let uu____11566 =
              ...
              let uu____12592 =
                FStar_Util.map_opt l.mlift_term
                  (fun l1  ->
                     ...
                     FStar_Syntax_Print.term_to_string uu____12610)
                 in
            ...
            FStar_All.pipe_right (env.effects).decls
              (FStar_List.map
                 (fun uu____12636  ->
                    ...
                    | (e,uu____12644) -> e.FStar_Syntax_Syntax.mname))
             in
                     ...
                     let uu____13172 =
                       let uu____13177 =
                         ...
                         FStar_Util.format3
                           ...
                           uu____13178 uu____13183 uu____13190
                          in
                ...
                (match (ed.FStar_Syntax_Syntax.repr).FStar_Syntax_Syntax.n
                 ...
                 | uu____13344 ->
                     ...
                     let uu____13409 =
                       ...
                       uu____13413 FStar_Pervasives_Native.None uu____13412
                        in
          ...
          let uu____13487 =
            let uu____13488 =
              let uu____13493 =
                ...
                FStar_Util.format1 "Effect %s cannot be reified" uu____13494
                 in
              let uu____13495 = get_range env  in (uu____13493, uu____13495)
               in
  ...
  fun env  ->
    fun s  ->
      let rec push1 x rest =
        ...
        | [] -> [x]
        | local::rest1 ->
            let uu____13617 = push1 x rest1  in local :: uu____13617
         in
                ...
                | Binding_sig_inst (ls,uu____14432,uu____14433) ->
                    let uu____14438 =
                      ...
                      FStar_All.pipe_right uu____14439
                        (FStar_String.concat ", ")
                       in
                    Prims.strcat "Binding_sig_inst " uu____14438))
         in
    ...
    fun path  ->
      ...
      let rec should_enc_path' pns path1 =
        ...
        | (p,b)::pns1 ->
            ...
            if uu____14684 then b else should_enc_path' pns1 path1
         in
...
let dummy_solver : solver_t =
  {
    ...
    preprocess =
      (fun e  ->
         fun g  ->
           let uu____14886 =
             let uu____14893 = FStar_Options.peek ()  in (e, g, uu____14893)
              in
           [uu____14886]);
