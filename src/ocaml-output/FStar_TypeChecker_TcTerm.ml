      ...
      (let top = FStar_Syntax_Subst.compress e  in
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           let uu____1948 =
             ...
             FStar_All.pipe_right uu____1949 FStar_Syntax_Util.lcomp_of_comp
              in
                               ...
                               let uu____2607 =
                                 let uu____2614 =
                                   FStar_Syntax_Syntax.mk
                                     ...
                                     top.FStar_Syntax_Syntax.pos
                                    in
                                 comp_check_expected_typ env1 uu____2614 c1
                                  in
            ...
            | (unary_op,uu____2742) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    ...
                    FStar_Pervasives_Native.None uu____2766
                   in
                let t =
                  FStar_Syntax_Syntax.mk
           ...
           (match uu____2869 with
            | (unary_op,uu____2891) ->
                let head1 =
                  ...
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (unary_op, [a]))
                    FStar_Pervasives_Native.None uu____2915
                   in
                let t =
                  FStar_Syntax_Syntax.mk
                    (FStar_Syntax_Syntax.Tm_app (head1, rest1))
           ...
           (if FStar_Option.isSome aqual
            ...
            (let uu____2987 =
               let uu____2994 = FStar_TypeChecker_Env.clear_expected_typ env1
                  in
               match uu____2994 with | (env0,uu____3008) -> tc_term env0 e1
                in
                 ...
                 (match uu____3022 with
                  | (reify_op,uu____3044) ->
                      ...
                      let repr =
                        ...
                        FStar_TypeChecker_Env.reify_comp env1 uu____3099 u_c
                         in
                      let e3 =
                        FStar_Syntax_Syntax.mk
                          (FStar_Syntax_Syntax.Tm_app
                                 ...
                                 let uu____3322 =
                                   let uu____3325 =
                                     let uu____3326 =
                                       ...
                                       (repr, uu____3341)  in
                                     FStar_Syntax_Syntax.Tm_app uu____3326
                                      in
                                   ...
                                   (match uu____3392 with
                                    | FStar_Syntax_Syntax.Tm_app
                                        (uu____3408,(res,uu____3410)::
                                         (wp,uu____3412)::[])
                                        -> (t1, res, wp, g)
                                    | uu____3455 -> failwith "Impossible")
                                in
           ...
           let env2 =
             let uu____3657 =
               let uu____3658 = FStar_TypeChecker_Env.clear_expected_typ env1
                  in
               FStar_All.pipe_right uu____3658 FStar_Pervasives_Native.fst
                in
                       ...
                       (let uu____3795 = comp_check_expected_typ env0 e1 c
                        ...
                        | (e2,c1,g') ->
                            ...
                            let gres =
                              ...
                              FStar_TypeChecker_Rel.conj_guard g uu____3930
                               in
                            ((let uu____3932 =
                                FStar_TypeChecker_Env.debug env2
                                  FStar_Options.Extreme
                                       ...
                                       let uu____4552 =
                                         let uu____4555 =
                                           ...
                                           FStar_Syntax_Syntax.Tm_let
                                             uu____4556
                                            in
                                         FStar_Syntax_Syntax.mk uu____4555
                                          in
                                       uu____4552
                                         FStar_Pervasives_Native.None
                                         top.FStar_Syntax_Syntax.pos
  ...
  fun env  ->
    fun e  ->
      let check_instantiated_fvar env1 v1 dc e1 t =
        let uu____5168 = FStar_TypeChecker_Util.maybe_instantiate env1 e1 t
           in
                ...
                | (e1,uu____5493,g1) ->
                    let uu____5507 =
                      ...
                      FStar_All.pipe_right uu____5508
                        FStar_Syntax_Util.lcomp_of_comp
                       in
                    let uu____5509 = FStar_TypeChecker_Rel.conj_guard g0 g1
                       in
                 ...
                 | (e2,t1,implicits) ->
                     let tc =
                       ...
                       then FStar_Util.Inl t1
                         ...
                         (let uu____5573 =
                            let uu____5574 = FStar_Syntax_Syntax.mk_Total t1
                               in
                            FStar_All.pipe_left
                              FStar_Syntax_Util.lcomp_of_comp uu____5574
                             in
                          FStar_Util.Inr uu____5573)
                        in
               ...
               (if (FStar_List.length us1) <> (FStar_List.length us')
                then
                  (let uu____5648 =
                     let uu____5649 =
                       let uu____5654 =
                         let uu____5655 = FStar_Syntax_Print.fv_to_string fv
                            in
                         let uu____5656 =
                         ...
                         FStar_Util.format3
                          ...
                          in
                       let uu____5658 = FStar_TypeChecker_Env.get_range env1
                          in
      ...
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          ...
          (match uu____5738 with
           | (bs1,c1) ->
               let env0 = env1  in
               let uu____5752 = FStar_TypeChecker_Env.clear_expected_typ env1
                  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
          ...
          (match uu____5837 with
           | (x1,phi1) ->
               let env0 = env1  in
               let uu____5853 = FStar_TypeChecker_Env.clear_expected_typ env1
                  in
           ...
           | (tc1,uu____6186,f) ->
               ...
               (match uu____6188 with
                | (head3,args) ->
                    let comp_univs =
                      let uu____6232 =
                        let uu____6233 = FStar_Syntax_Subst.compress head3
                           in
                              ...
                              then
                                ...
                                (let uu____8999 =
                                   ...
                                   | (lifted_args,reverse_args) ->
                                       ...
                                       (lifted_args, uu____9435, uu____9445)
                                    in
                             ...
                             (let uu____10229 = tc_term env2 e  in
                              ...
                              | (e1,c,g_e) ->
                                  ...
                                  let xterm =
                                    ...
                                    FStar_Syntax_Syntax.as_arg uu____10256
                                     in
                                  let uu____10257 =
                     ...
                     (match uu____10803 with
                      | (args1,comps,g_args) ->
                                   ...
                                   (fun uu____10878  ->
                                      ...
                                      | (uu____10891,c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None)))
                               in
                            FStar_Syntax_Util.null_binders_of_tks uu____10840
                             in
                          let ml_or_tot t r1 =
                          ...
                          let cres =
                            let uu____10911 =
                              let uu____10914 =
                                let uu____10915 = FStar_Syntax_Util.type_u ()
                                   in
                                FStar_All.pipe_right uu____10915
                                  FStar_Pervasives_Native.fst
                                 in
                              FStar_TypeChecker_Util.new_uvar env uu____10914
                               in
                     ...
                     (match uu____11174 with
                      | (args1,comps,g_args) ->
                                   ...
                                   (fun uu____11249  ->
                                      ...
                                      | (uu____11262,c) ->
                                          ((c.FStar_Syntax_Syntax.res_typ),
                                            FStar_Pervasives_Native.None)))
                               in
                            FStar_Syntax_Util.null_binders_of_tks uu____11211
                             in
                          let ml_or_tot t r1 =
                          ...
                          let cres =
                            let uu____11282 =
                              let uu____11285 =
                                let uu____11286 = FStar_Syntax_Util.type_u ()
                                   in
                                FStar_All.pipe_right uu____11286
                                  FStar_Pervasives_Native.fst
                                 in
                              FStar_TypeChecker_Util.new_uvar env uu____11285
                               in
                                         ...
                                         let uu____11693 =
                                           let uu____11702 =
                                             FStar_Syntax_Syntax.as_arg e1
                                              in
                                           [uu____11702]  in
                                         FStar_List.append seen uu____11693
                                          in
                                       let uu____11709 =
                                         FStar_TypeChecker_Rel.conj_guard
                                           guard g1
                      ...
                      (match uu____12156 with
                       | (pattern1,pat_bvs1,pat_env,pat_exp,norm_pat_exp) ->
                           ...
                           (match uu____12194 with
                            | (when_clause1,g_when) ->
                                let uu____12271 = tc_term pat_env branch_exp
                                   in
                   ...
                   (let g11 =
                    ...
                    let uu____12904 =
                      let uu____12913 =
                        let uu____12924 =
                          let uu____12933 =
                            let uu____12946 = c1.FStar_Syntax_Syntax.comp ()
                               in
                    ...
                    let uu____13009 =
                      ...
                      then
                        ...
                        (FStar_TypeChecker_Rel.force_trivial_guard env1 g11;
                         (let c =
                            let uu____13057 = c11.FStar_Syntax_Syntax.comp ()
                               in
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),e2) ->
          ...
          let uu____13136 =
            let uu____13147 =
              let uu____13148 = FStar_TypeChecker_Env.clear_expected_typ env2
                 in
              FStar_All.pipe_right uu____13148 FStar_Pervasives_Native.fst
               in
           ...
           | (e1,uu____13170,c1,g1,annotated) ->
               ...
               (match uu____13176 with
                | (xb,e21) ->
                    ...
                    let uu____13201 =
                      let uu____13208 = FStar_TypeChecker_Env.push_bv env2 x1
                         in
                         ...
                         let x_eq_e1 =
                           let uu____13258 =
                             ...
                             FStar_Syntax_Util.mk_eq2 uu____13259
                               c1.FStar_Syntax_Syntax.res_typ uu____13260 e11
                              in
                           FStar_All.pipe_left
                             (fun _0_43  ->
                           ...
                           let uu____13262 =
                             let uu____13263 =
                               FStar_TypeChecker_Rel.guard_of_guard_formula
                                 x_eq_e1
                                in
                             FStar_TypeChecker_Rel.imp_guard uu____13263 g2
                              in
                              ...
                              let cres =
                                let uu____13573 =
                                  FStar_Syntax_Syntax.mk_Total
                                   ...
                                   in
                                FStar_All.pipe_left
                                  FStar_Syntax_Util.lcomp_of_comp uu____13573
                                 in
                              let uu____13578 =
        ...
        let termination_check_enabled lbname lbdef lbtyp =
                  ...
                  let formals_msg =
                    ...
                    then "1 argument"
                      ...
                      (let uu____13963 = FStar_Util.string_of_int n1  in
                       FStar_Util.format1 "%s arguments" uu____13963)
                     in
                  let msg =
                    let uu____13971 = FStar_Syntax_Print.term_to_string lbtyp
                       in
                    let uu____13972 =
                      FStar_Syntax_Print.lbname_to_string lbname  in
                    FStar_Util.format4
                      "From its type %s, the definition of `let rec %s` expects a function with %s, but %s"
                      uu____13971 uu____13972 formals_msg actuals_msg
                     in
                  FStar_Exn.raise
                    (FStar_Errors.Error
          ...
          | uu____13979 ->
              let uu____13984 =
                let uu____13985 =
                  let uu____13990 =
                    let uu____13991 = FStar_Syntax_Print.term_to_string lbdef
                       in
                    let uu____13992 = FStar_Syntax_Print.term_to_string lbtyp
                       in
                    FStar_Util.format2
                            ...
                            then t
                              ...
                              (let uu____14059 =
                                 let uu____14066 =
                                   ...
                                   FStar_All.pipe_left
                                     FStar_Pervasives_Native.fst uu____14067
                                    in
                                 tc_check_tot_or_gtot_term
             ...
             | (univ_opening,univ_vars1) ->
                 ...
                 then
                   ...
                   (let uu____14482 = FStar_Syntax_Util.type_u ()  in
                    ...
                    | (k,uu____14502) ->
                        let uu____14503 = tc_check_tot_or_gtot_term env1 t1 k
                           in
                                 ...
                                 let uu____14529 =
                                   let uu____14530 =
                                     FStar_Syntax_Syntax.range_of_lbname
                                       lb.FStar_Syntax_Syntax.lbname
                                      in
                                   FStar_Range.string_of_range uu____14530
                                    in
                                 let uu____14531 =
           ...
           fun uu____15022  ->
             ...
             | (pats1,g) ->
                 ...
                 (match uu____15047 with
                  | (args,g') ->
                      let uu____15060 = FStar_TypeChecker_Rel.conj_guard g g'
                         in
        ...
        let uu____15323 =
          let uu____15324 =
            let uu____15329 =
              ...
              FStar_Util.format2
                "Expected a term of type 'Type'; got %s : %s" uu____15330 t
               in
           ...
           | ((us',t),uu____15635) ->
               (if (FStar_List.length us) <> (FStar_List.length us')
                then
                  (let uu____15641 =
                     let uu____15642 =
                       let uu____15647 = FStar_TypeChecker_Env.get_range env
                          in
           ...
           | (bs1,c1) ->
               ...
               let u_c =
                 ...
                 | FStar_Pervasives_Native.Some trepr ->
                     ...
                     level_of_type env trepr uu____15735
                  in
               let u =
            ...
            | FStar_Syntax_Syntax.Tm_match (uu____16094,hd4::uu____16096) ->
                ...
                (match uu____16161 with
                 | (uu____16176,uu____16177,hd5) ->
                     let uu____16195 = FStar_Syntax_Util.head_and_args hd5
                        in
