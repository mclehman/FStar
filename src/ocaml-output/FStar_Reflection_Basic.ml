    ...
    | FStar_Reflection_Data.Pat_Constant c ->
        let uu____410 =
          ...
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.ref_Pat_Constant uu____411
           in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(l,uu____1079)::(r,uu____1081)::[]) when
             ...
             let uu____1116 =
               ...
               let uu____1122 = unembed_argv r  in (uu____1121, uu____1122)
                in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1133)::(t2,uu____1135)::[]) when
             ...
             let uu____1170 =
               ...
               let uu____1176 = unembed_term t2  in (uu____1175, uu____1176)
                in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1179)::(t2,uu____1181)::[]) when
             ...
             let uu____1216 =
               ...
               let uu____1222 = unembed_comp t2  in (uu____1221, uu____1222)
                in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1253)::(t2,uu____1255)::[]) when
             ...
             let uu____1290 =
               ...
               let uu____1296 = unembed_term t2  in (uu____1295, uu____1296)
                in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(u,uu____1327)::(t2,uu____1329)::[]) when
             ...
             let uu____1364 =
               ...
               let uu____1370 = unembed_term t2  in (uu____1369, uu____1370)
                in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(pre,uu____1645)::(post,uu____1647)::[]) when
             ...
             let uu____1682 =
               ...
               let uu____1688 = unembed_term post  in
                ...
                let uu____2251 =
                  FStar_List.map
                    (fun uu____2263  ->
                       ...
                       | (p1,uu____2271) -> inspect_pat p1) ps
                   in
                (fv, uu____2251)  in
        ...
        let brs2 =
          FStar_List.map
            (fun uu___103_2324  ->
               ...
               | (pat,uu____2346,t4) ->
                   let uu____2364 = inspect_pat pat  in (uu____2364, t4))
            brs1
           in
  ...
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_App (l,(r,q)) ->
        (match q with
         | FStar_Reflection_Data.Q_Explicit  ->
             let uu____2500 =
               let uu____2509 = FStar_Syntax_Syntax.as_arg r  in [uu____2509]
                in
             FStar_Syntax_Util.mk_app l uu____2500
         | FStar_Reflection_Data.Q_Implicit  ->
             let uu____2510 =
               let uu____2519 = FStar_Syntax_Syntax.iarg r  in [uu____2519]
                in
          ...
          FStar_List.map
            (fun uu___104_2677  ->
               ...
               | (pat,t1) ->
                   ...
                   (uu____2694, FStar_Pervasives_Native.None, t1)) brs
           in
  ...
  fun c  ->
    ...
    | FStar_Reflection_Data.Ctor (nm,t) ->
        let uu____3171 =
          let uu____3172 =
            let uu____3173 =
              let uu____3174 = FStar_Syntax_Embeddings.embed_string_list nm
                 in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu____3251)::(t2,uu____3253)::[]) when
             ...
             let uu____3288 =
               ...
               let uu____3296 = unembed_term t2  in (uu____3293, uu____3296)
                in
  ...
  fun sev  ->
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm,bs,t,dcs) ->
        let uu____3328 =
          let uu____3329 =
            let uu____3330 =
              let uu____3331 = FStar_Syntax_Embeddings.embed_string_list nm
                 in
          ...
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.ref_Sg_Inductive uu____3329
           in
