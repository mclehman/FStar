                  ...
                  | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____616)
                      ...
                      let lid =
                        ...
                        | uu____641 ->
                         ...
                         in
                      ((let uu____647 =
                          let uu____650 = FStar_ST.op_Bang in_progress  in
                          lid :: uu____650  in
                              ...
                              | () ->
                                  ...
                                  let tm' =
                                    FStar_Syntax_InstFV.inst unfold_abbrev_fv
                                     ...
                                     in
                                  let lb' =
                                    let uu___214_785 = lb  in
                                    {
                                      FStar_Syntax_Syntax.lbname =
                                        (uu___214_785.FStar_Syntax_Syntax.lbname);
                                      FStar_Syntax_Syntax.lbunivs =
                                        (uu___214_785.FStar_Syntax_Syntax.lbunivs);
                                      FStar_Syntax_Syntax.lbtyp = ty';
                                      FStar_Syntax_Syntax.lbeff =
                                        (uu___214_785.FStar_Syntax_Syntax.lbeff);
                                  ...
                                  ((let uu____798 =
                                      let uu____801 =
                                        FStar_ST.op_Bang
                                         ...
                                         in
                                      (let uu___215_869 = x  in
                                       {
                                         FStar_Syntax_Syntax.sigel = sigelt';
                                         FStar_Syntax_Syntax.sigrng =
                                           (uu___215_869.FStar_Syntax_Syntax.sigrng);
                                         FStar_Syntax_Syntax.sigquals =
                                           quals1;
                                         FStar_Syntax_Syntax.sigmeta =
                                           (uu___215_869.FStar_Syntax_Syntax.sigmeta);
                                         FStar_Syntax_Syntax.sigattrs =
                                           (uu___215_869.FStar_Syntax_Syntax.sigattrs)
                                       }) :: uu____801
                                       in
              ...
              let inductives_with_abbrevs_unfolded =
                    ...
                    (fun x  ->
                       ...
                       | FStar_Syntax_Syntax.Sig_let
                           ...
                           FStar_Ident.lid_equals
                             ...
                             (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                           -> FStar_Pervasives_Native.Some tm
                       | uu____1287 -> FStar_Pervasives_Native.None)
                   in
                let unfold_fv t fv =
                ...
                let unfold_in_sig x =
                  ...
                  | FStar_Syntax_Syntax.Sig_inductive_typ
                      ...
                      [(let uu___216_1340 = x  in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_inductive_typ
                               (lid, univs1, bnd', ty', mut', dc));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___216_1340.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals =
                            (uu___216_1340.FStar_Syntax_Syntax.sigquals);
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___216_1340.FStar_Syntax_Syntax.sigmeta);
                          FStar_Syntax_Syntax.sigattrs =
                            (uu___216_1340.FStar_Syntax_Syntax.sigattrs)
                        })]
                  | FStar_Syntax_Syntax.Sig_datacon
                      (lid,univs1,ty,res,npars,mut) ->
                      let ty' = FStar_Syntax_InstFV.inst unfold_fv ty  in
                      let mut' = filter_out_type_abbrevs mut  in
                      [(let uu___217_1360 = x  in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_datacon
                               (lid, univs1, ty', res, npars, mut'));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___217_1360.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals =
                            (uu___217_1360.FStar_Syntax_Syntax.sigquals);
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___217_1360.FStar_Syntax_Syntax.sigmeta);
                          FStar_Syntax_Syntax.sigattrs =
                            (uu___217_1360.FStar_Syntax_Syntax.sigattrs)
                        })]
