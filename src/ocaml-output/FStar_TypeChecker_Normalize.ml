...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let string_as_const p b = const_as_tm (FStar_Const.Const_string (b, p)) p
     in
  ...
  let unary_op as_a f r args =
    let uu____4782 = FStar_List.map as_a args  in lift_unary (f r) uu____4782
     in
  let binary_op as_a f r args =
    let uu____4838 = FStar_List.map as_a args  in
    lift_binary (f r) uu____4838  in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____4910 = f x  in int_as_const r uu____4910)
     in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4938 = f x y  in int_as_const r uu____4938)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  -> let uu____4959 = f x  in bool_as_const r uu____4959)
     in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____4987 = f x y  in bool_as_const r uu____4987)
     in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____5015 = f x y  in string_as_const r uu____5015)
     in
        ...
        let uu____5620 =
          let uu____5635 =
                                                    ...
                                                    let uu____6106 =
                                                      let uu____6127 =
                                                        ...
                                                        (uu____6146,
                                                         ...
                                                         in
                                                      [uu____6127]  in
                                                    uu____6074 :: uu____6106
                                                     in
                                                  uu____6015 :: uu____6051
                                                   in
            ...
            (FStar_Parser_Const.op_Division, (Prims.parse_int "2"),
              (binary_int_op (fun x  -> fun y  -> x / y))) :: uu____5650
             in
          (FStar_Parser_Const.op_Multiply, (Prims.parse_int "2"),
            (binary_int_op (fun x  -> fun y  -> x * y))) :: uu____5635
           in
        (FStar_Parser_Const.op_Subtraction, (Prims.parse_int "2"),
          (binary_int_op (fun x  -> fun y  -> x - y))) :: uu____5620
         in
      (FStar_Parser_Const.op_Addition, (Prims.parse_int "2"),
        (binary_int_op (fun x  -> fun y  -> x + y))) :: uu____5605
       in
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> - x))) :: uu____5590
     in
    ...
    FStar_All.pipe_right bounded_int_types
      (FStar_List.collect
         (fun m  ->
            ...
            let uu____6850 =
              let uu____6865 =
                let uu____6878 = FStar_Parser_Const.p2l ["FStar"; m; "sub"]
                   in
              ...
              let uu____6927 =
                let uu____6942 =
                  let uu____6955 = FStar_Parser_Const.p2l ["FStar"; m; "mul"]
                     in
...
let tr_norm_step : FStar_Syntax_Embeddings.norm_step -> step Prims.list =
  fun uu___173_10424  ->
    ...
    | FStar_Syntax_Embeddings.UnfoldOnly names1 ->
        let uu____10430 =
          let uu____10433 =
            let uu____10434 = FStar_List.map FStar_Ident.lid_of_str names1
               in
  ...
  fun full_norm  ->
    fun args  ->
      let parse_steps s =
        let uu____10491 =
          FStar_Syntax_Embeddings.unembed_list
            FStar_Syntax_Embeddings.unembed_norm_step s
           in
      ...
      | (steps,uu____10544)::uu____10545::(tm,uu____10547)::[] ->
          ...
          let s =
            let uu____10587 =
              let uu____10590 = full_norm steps  in parse_steps uu____10590
               in
            Beta :: uu____10587  in
               ...
               let should_delta1 =
                 ...
                 then false
                   ...
                   (let uu____11362 =
                    ...
                    | uu____11377 -> should_delta)
                  in
               (log cfg
                  (fun uu____11385  ->
                     let uu____11386 = FStar_Syntax_Print.term_to_string t1
                        in
                     let uu____11387 =
                ...
                then rebuild cfg env stack1 t1
                  ...
                  (let r_env =
                     ...
                     FStar_TypeChecker_Env.set_range cfg.tcenv uu____11391
                      in
                   let uu____11392 =
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11883  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11973  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12159  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12257  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12339  -> Dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                      ...
                      let c2 =
                        let uu____12623 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env1  ->
                                  fun uu____12635  -> Dummy :: env1) env)
                           in
                    ...
                    (log cfg
                     ...
                     (let tc1 =
                      ...
                      let uu____12780 =
                        let uu____12781 =
                          let uu____12782 =
                            let uu____12809 = FStar_Syntax_Util.unascribe t12
                               in
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____13147 =
                                   let uu____13150 =
                                     FStar_List.map
                                       (fun uu____13158  -> Dummy) xs1
                                      in
                                   FStar_List.append uu____13150 env  in
                                 FStar_List.append uu____13142 uu____13147
                                  in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____14105 =
                         let uu____14106 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____14124 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       let uu____14139 =
                                         ...
                                         uu____14140.FStar_Syntax_Syntax.n
                                          in
                                           ...
                                           let uu____14156 =
                                             let uu____14157 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____14157.FStar_Syntax_Syntax.n
                                              in
                                     ...
                                     (match uu____14177 with
                                      ...
                                      | FStar_Pervasives_Native.None  ->
                                          let uu____14218 =
                                            let uu____14219 = is_return body
                                               in
                                               ...
                                               let uu____14293 =
                                                 let uu____14294 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____14294.FStar_Syntax_Syntax.n
                                                  in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____14416 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                let maybe_unfold_action head2 =
                                  let maybe_extract_fv t3 =
                                    ...
                                    | uu____14472 ->
                                        FStar_Pervasives_Native.None
                                     in
                                  let uu____14473 = maybe_extract_fv head2
                                     in
                                ...
                                ((let is_arg_impure uu____14514 =
                                    ...
                                    | (e,q) ->
                                        let uu____14521 =
                                          let uu____14522 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____14522.FStar_Syntax_Syntax.n
                                           in
                                  ...
                                  | (head_app1,found_action) ->
                                      ...
                                      let body1 =
                                        ...
                                        | FStar_Pervasives_Native.Some (true
                                         ...
                                         in
                                      let uu____14593 = FStar_List.tl stack1
                                         in
                    ...
                    let uu____14964 =
                      let uu____14965 =
                        let uu____14980 =
                          ...
                          let uu____14984 =
                            let uu____14987 = FStar_Syntax_Syntax.as_arg e
                               in
                            [uu____14987]  in
      ...
      fun uu____15323  ->
        ...
        | (x,imp) ->
            let uu____15326 =
              ...
              let uu____15328 = norm cfg env [] x.FStar_Syntax_Syntax.sort
                 in
              {
                FStar_Syntax_Syntax.ppname =
      ...
      fun stack1  ->
        fun t  ->
          ...
          | (Arg (Clos (env1,tm,m,uu____15602),aq,r))::stack2 ->
              (log cfg
                 (fun uu____15631  ->
                    let uu____15632 = FStar_Syntax_Print.term_to_string tm
                       in
                  ...
                  (let whnf1 = FStar_List.contains WHNF cfg.steps  in
                             ...
                             (FStar_List.fold_left
                                (fun uu____15999  ->
                                   fun uu____16000  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____16103 = norm_pat env3 p1
                                            in
                   ...
                   let uu____16342 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____16342)
                   in
                      ...
                      (match uu____16708 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____16733 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____16875 =
                                        ...
                                        Clos uu____16876  in
                                      uu____16875 :: env2) env1 s
                                in
                             let uu____16948 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____16948)))
                   in
                let uu____16949 =
                  FStar_All.pipe_right cfg.steps
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____17154 =
                     let uu____17155 =
                       let uu____17162 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____17162)  in
           ...
           | (head1,args) ->
               ...
               (match uu____17346 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____17350,thead) ->
                    let uu____17376 = FStar_Syntax_Util.arrow_formals thead
                       in
        ...
        fun tc  ->
          let t =
            ...
            | (uu____17526,FStar_Util.Inl t) ->
             ...
             in
          let uu____17553 = FStar_Syntax_Subst.open_univ_vars univ_names t
             in
                ...
                | uu____17635 ->
                    ...
                    (match uu____17636 with
                     ...
                     | (uu____17747,FStar_Util.Inl uu____17748) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____17771 -> failwith "Impossible")
                 in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____18334 with
           | (univs1,binders,signature) ->
               let uu____18362 =
                 let uu____18371 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____18371 with
                 | (univs_opening,univs2) ->
                     let uu____18398 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____18398)
                  in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____18795 = destruct_action_body body
                                    in
                           ...
                           | (action_univs,t) ->
                               let uu____18899 = destruct_action_typ_templ t
                                  in
