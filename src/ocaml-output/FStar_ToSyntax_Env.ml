        ...
        FStar_All.pipe_right env.remaining_iface_decls
          (FStar_List.tryFind
             (fun uu____2049  ->
                ...
                | (m,uu____2057) -> FStar_Ident.lid_equals l m))
         in
    ...
    fun id  ->
      fun k_global_def  ->
        fun k_not_found  ->
          ...
          | FStar_Pervasives_Native.None  ->
              let lid =
                let uu____3637 = current_module env  in qual uu____3637 id
                 in
        ...
        let uu____3951 =
          is_full_path &&
            (let uu____3953 = FStar_Ident.lid_of_ids ids  in
             module_is_defined env uu____3953)
           in
        if uu____3951
        then (ids, [])
        else
        ...
        fun lid  ->
                     ...
                     let uu____4522 =
                       let uu____4523 =
                         let uu____4528 =
                           ...
                           FStar_Syntax_Syntax.fvar source_lid
                             FStar_Syntax_Syntax.Delta_constant uu____4529
                            in
                         (uu____4528, false)  in
                            ...
                            let uu____4608 =
                              let uu____4609 =
                                let uu____4614 =
                                  ...
                                  FStar_Syntax_Syntax.fvar lid2 dd uu____4615
                                   in
                                (uu____4614, false)  in
          ...
          let k_rec_binding uu____4670 =
            ...
            | (id,l,dd) ->
                ...
                FStar_Pervasives_Native.Some uu____4682
             in
          let found_unmangled =
            match lid.FStar_Ident.ns with
            | [] ->
    ...
    fun lid  ->
      ...
      let uu____5141 =
        resolve_in_open_namespaces' env lid
          ...
          (fun uu____5153  -> FStar_Pervasives_Native.None) k_global_def
         in
                                                             ...
                                                             let uu____7591 =
                                                               let uu____7592
                                                                 ...
                                                                 FStar_Syntax_Util.mk_field_projector_name_from_ident
                                                                   ...
                                                                   id
                                                                  in
                                                               uu____7592.FStar_Ident.ident
                                                                in
                                                             uu____7591.FStar_Ident.idText
                                                              in
                                                           let uu____7594 =
                                                             let uu____7595 =
                                                               FStar_ST.op_Bang
        ...
        | FStar_Pervasives_Native.Some record' when
            ...
            let uu____7838 =
              find_in_record (record.typename).FStar_Ident.ns
                lid.FStar_Ident.ident record (fun uu____7842  -> Cont_ok ())
               in
        ...
        | FStar_Syntax_Syntax.Sig_bundle (ses,uu____8281) ->
            let uu____8290 =
              FStar_List.map
               ...
               in
            (env2, uu____8290)
        | uu____8317 -> (env2, [((FStar_Syntax_Util.lids_of_sigelt s), s)])
         in
                           ...
                           cur_trans_exports) ->
                            let update_exports k =
                              ...
                              (let uu____9357 =
                                 ...
                                 FStar_Util.set_difference uu____9358 ns_ex
                                  in
                              ...
                              (match () with
                               | () ->
                                   ...
                                   let uu____9492 =
                                     ...
                                     FStar_Util.set_union uu____9493 ns_ex
                                      in
              ...
              | FStar_Pervasives_Native.Some old_doc ->
                  let uu____9699 =
                    ...
                    FStar_Util.format3
                      ...
                      uu____9700 uu____9701 uu____9702
                     in
                     ...
                     ((let uu____9731 =
                       ...
                       then
                         let uu____9733 =
                           ...
                           FStar_Util.format1
                             "Admitting %s without a definition" uu____9734
                            in
      ...
      FStar_All.pipe_right modul.FStar_Syntax_Syntax.declarations
        (FStar_List.iter
           (fun se  ->
              ...
              | uu____9876 -> ()));
      (let curmod =
         let uu____9878 = current_module env  in uu____9878.FStar_Ident.str
          in
       (let uu____9880 =
        ...
        | (FStar_Pervasives_Native.Some cur_ex,FStar_Pervasives_Native.Some
           cur_trans_ex) ->
            let update_exports eikind =
              let cur_ex_set =
                let uu____9958 = cur_ex eikind  in
                FStar_ST.op_Bang uu____9958  in
...
let as_exported_ids : exported_id_set -> exported_ids =
  fun e  ->
    ...
    let fields =
      let uu____11031 =
        let uu____11034 = e Exported_id_field  in
        FStar_ST.op_Bang uu____11034  in
              ...
              FStar_All.pipe_right env.modules
                (FStar_Util.find_opt
                   (fun uu____11806  ->
                      ...
                      | (l,uu____11812) -> FStar_Ident.lid_equals l mname))
               in
