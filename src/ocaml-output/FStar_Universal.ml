                             ...
                             then
                               ...
                               let uu____422 =
                                 FStar_ToSyntax_Env.set_iface
                                   env2.FStar_TypeChecker_Env.dsenv false
                                  in
                               {
                                 FStar_TypeChecker_Env.solver =
                           ...
                           let uu____435 =
                             let uu____444 =
                               FStar_ToSyntax_Env.syntax_only
                                 env4.FStar_TypeChecker_Env.dsenv
                                in
                             if uu____444
                             then (modul, [], env4)
                             else
                          ...
                          let uu____492 =
                            let uu____499 =
                              FStar_ToSyntax_Interleave.prefix_with_interface_decls
                                a_decl
                               in
                            FStar_All.pipe_left (with_tcenv env1) uu____499
                             in
    ...
    | (prims_mod,env) ->
        ((let uu____1688 =
            (let uu____1691 = FStar_Options.explicit_deps ()  in
             Prims.op_Negation uu____1691) && (FStar_Options.debug_any ())
             in
          if uu____1688
          then
