...
let rec univ_to_string : FStar_Syntax_Syntax.universe -> Prims.string =
  fun u  ->
    let uu____972 =
      let uu____973 = FStar_Options.ugly ()  in Prims.op_Negation uu____973
       in
    if uu____972
    then
...
let quals_to_string' :
  ...
  fun quals  ->
    ...
    | [] -> ""
    | uu____1132 ->
        let uu____1135 = quals_to_string quals  in
        Prims.strcat uu____1135 " "
  
let rec term_to_string : FStar_Syntax_Syntax.term -> Prims.string =
  fun x  ->
    let uu____1191 =
      let uu____1192 = FStar_Options.ugly ()  in Prims.op_Negation uu____1192
       in
    if uu____1191
    then
                         ...
                         FStar_All.pipe_right args
                           (FStar_List.map
                              (fun uu____1309  ->
                                 ...
                                 | (t1,uu____1315) -> term_to_string t1))
                          in
...
and pat_to_string : FStar_Syntax_Syntax.pat -> Prims.string =
  fun x  ->
    let uu____1726 =
      let uu____1727 = FStar_Options.ugly ()  in Prims.op_Negation uu____1727
       in
    if uu____1726
    then
                 ...
                 (fun lb  ->
                    let uu____1836 =
                      ...
                      FStar_Syntax_Subst.open_univ_vars
                        lb.FStar_Syntax_Syntax.lbunivs uu____1841
                       in
...
and comp_to_string : FStar_Syntax_Syntax.comp -> Prims.string =
  fun c  ->
    let uu____2061 =
      let uu____2062 = FStar_Options.ugly ()  in Prims.op_Negation uu____2062
       in
    if uu____2061
    then
               ...
               let uu____2118 =
                 let uu____2119 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.comp_univs
                    ...
                    in
                 FStar_All.pipe_right uu____2119 (FStar_String.concat ", ")
                  in
               let uu____2126 =
               ...
               let uu____2127 =
                 let uu____2128 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.effect_args
                    ...
                    in
                 FStar_All.pipe_right uu____2128 (FStar_String.concat ", ")
                  in
               let uu____2149 =
                 let uu____2150 =
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
                    ...
                    in
                 FStar_All.pipe_right uu____2150 (FStar_String.concat " ")
                  in
                    ...
                    (fun uu___210_2201  ->
                       ...
                       | FStar_Syntax_Syntax.DECREASES e ->
                           let uu____2207 =
                             ...
                             FStar_Util.format1 " (decreases %s)" uu____2208
                              in
                           [uu____2207]
                       | uu____2209 -> []))
                in
...
let tscheme_to_string : FStar_Syntax_Syntax.tscheme -> Prims.string =
  fun s  ->
    let uu____2262 =
      let uu____2263 = FStar_Options.ugly ()  in Prims.op_Negation uu____2263
       in
    if uu____2262
    then
...
let rec sigelt_to_string : FStar_Syntax_Syntax.sigelt -> Prims.string =
  fun x  ->
    let uu____2418 =
      let uu____2419 = FStar_Options.ugly ()  in Prims.op_Negation uu____2419
       in
    if uu____2418
    then
