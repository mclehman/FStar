                        ...
                        let uu____44 =
                          let uu____45 =
                            let uu____50 =
                              ...
                              Prims.strcat "Not yet implemented:" uu____51
                               in
        ...
        (fun env1  ->
           fun uu____294  ->
             ...
             | (bv,uu____304) ->
                 ...
                 let uu____311 = FStar_Extraction_ML_UEnv.bv_as_ml_tyvar bv
                    in
          ...
          fun def  ->
            ...
            | (bs,body) ->
                let assumed =
                  FStar_Util.for_some
                    (fun uu___178_422  ->
                       match uu___178_422 with
                       | FStar_Syntax_Syntax.Assumption  -> true
                       | uu____423 -> false) quals
                   in
    ...
    fun se  ->
      let extract_ctor ml_tyvars env1 ctor =
        let mlt =
          ...
          FStar_Extraction_ML_Util.eraseTypeDeep
            (FStar_Extraction_ML_Util.udelta_unfold env1) uu____1112
           in
        let steps =
       ...
       | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____2343) when
           ...
           let uu____2359 =
             ...
             | (tcenv,uu____2392,def_typ) ->
                 let uu____2398 = as_pair def_typ  in (tcenv, uu____2398)
              in
                        ...
                        let uu____2461 =
                          let uu____2462 =
                            FStar_Extraction_ML_Syntax.string_of_mlpath
                             ...
                             in
                          FStar_Util.starts_with uu____2462 "FStar.Tactics"
                           in
             ...
             let mk_registration tac_lid assm_lid t bs =
                   ...
                   let uu____2494 =
                     let uu____2495 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____2495
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____2494  in
                 FStar_All.pipe_left
                   (FStar_Extraction_ML_Syntax.with_ty
                      FStar_Extraction_ML_Syntax.MLTY_Top) uu____2493
                  in
               let lid_arg =
                 let uu____2497 =
               ...
               | FStar_Pervasives_Native.Some tac_interpretation ->
                   let app =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.MLTY_Top) uu____2521
                      in
                 ...
                 (match uu____2539 with
                  | (bs,comp) ->
                      ...
                      (match uu____2569 with
                       | FStar_Syntax_Syntax.Tm_app (h,args) ->
                           ...
                           let assm_lid =
                             ...
                             FStar_Ident.lid_of_ns_and_id
                               tac_lid.FStar_Ident.ns uu____2604
                              in
                       ...
                       | uu____2625 -> []))
             | uu____2626 -> []  in
           let uu____2629 = FStar_Extraction_ML_Term.term_as_mlexpr g elet
              in
                                ...
                                | ((env,ml_lbs),{
                                    ...
                                    let lb_lid =
                                      let uu____2743 =
                                        ...
                                        uu____2746.FStar_Syntax_Syntax.fv_name
                                         in
                                              ...
                                              (let uu___187_2784 = ml_lb  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mllb_tysc
                                                   =
                                                   (uu___187_2784.FStar_Extraction_ML_Syntax.mllb_tysc);
                                                 FStar_Extraction_ML_Syntax.mllb_add_unit
                                                   =
                                                   (uu___187_2784.FStar_Extraction_ML_Syntax.mllb_add_unit);
                                                 FStar_Extraction_ML_Syntax.mllb_def
                                                   =
                                                   (uu___187_2784.FStar_Extraction_ML_Syntax.mllb_def);
                                                 FStar_Extraction_ML_Syntax.print_typ
                                                   =
                                                   (uu___187_2784.FStar_Extraction_ML_Syntax.print_typ)
                                               }))
                                      else
                                        (let uu____2788 =
                                           let uu____2789 =
                              ...
                              let uu____2842 =
                                let uu____2843 =
                                  FStar_Extraction_ML_Util.mlloc_of_range
                                   ...
                                   in
                                FStar_Extraction_ML_Syntax.MLM_Loc uu____2843
                                 in
                              [uu____2842;
                              FStar_Extraction_ML_Syntax.MLM_Let
             ...
             let always_fail =
                 ...
                 FStar_Syntax_Syntax.Sig_let uu____2928  in
               {
                 ...
                 FStar_Syntax_Syntax.sigrng =
                   (uu___188_2926.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___188_2926.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___188_2926.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___188_2926.FStar_Syntax_Syntax.sigattrs)
               }  in
        ...
        let g1 =
             ...
             in
          {
            ...
            FStar_Extraction_ML_UEnv.gamma =
              (uu___189_3170.FStar_Extraction_ML_UEnv.gamma);
            FStar_Extraction_ML_UEnv.tydefs =
              (uu___189_3170.FStar_Extraction_ML_UEnv.tydefs);
            FStar_Extraction_ML_UEnv.type_names =
              (uu___189_3170.FStar_Extraction_ML_UEnv.type_names);
