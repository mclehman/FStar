            ...
            | (embedded_state,uu____55)::[] ->
                ...
                (FStar_Tactics_Basic.log ps
                   (fun uu____77  ->
                      ...
                      let uu____79 = FStar_Syntax_Print.args_to_string args
                         in
                      FStar_Util.print2 "Reached %s, args are: %s\n" uu____78
                        uu____79);
                 (let res = FStar_Tactics_Basic.run t ps  in
                  let uu____83 =
                    FStar_Tactics_Embedding.embed_result ps res embed_a t_a
                     in
            ...
            fun args  ->
              ...
              | uu____196 ->
                  let uu____197 =
                    ...
                    let uu____199 = FStar_Syntax_Print.args_to_string args
                       in
                    FStar_Util.format2
              ...
              fun args  ->
                ...
                | uu____343 ->
                    let uu____344 =
                      ...
                      let uu____346 = FStar_Syntax_Print.args_to_string args
                         in
                      FStar_Util.format2
                        "Unexpected application of tactic primitive %s %s"
                        uu____345 uu____346
                  ...
                  fun nm  ->
                    fun args  ->
                      ...
                      | (a,uu____668)::(b,uu____670)::(c,uu____672)::
                          ...
                          (FStar_Tactics_Basic.log ps
                             (fun uu____750  ->
                                let uu____751 = FStar_Ident.string_of_lid nm
                                   in
                                let uu____752 =
                                  FStar_Syntax_Print.term_to_string
                                    embedded_state
...
let rec primitive_steps :
  ...
  fun uu____798  ->
    ...
    let mktac0 name f e_a ta =
      mk1 name (Prims.parse_int "1") (mk_tactic_interpretation_0 f e_a ta)
       in
    let mktac1 name f u_a e_b tb =
      mk1 name (Prims.parse_int "2")
        (mk_tactic_interpretation_1 f u_a e_b tb)
       in
    let mktac2 name f u_a u_b e_c tc1 =
      mk1 name (Prims.parse_int "3")
        (mk_tactic_interpretation_2 f u_a u_b e_c tc1)
       in
    let mktac3 name f u_a u_b u_c e_d tc1 =
      mk1 name (Prims.parse_int "4")
        (mk_tactic_interpretation_3 f u_a u_b u_c e_d tc1)
       in
    let mktac5 name f u_a u_b u_c u_d u_e e_f tc1 =
      mk1 name (Prims.parse_int "6")
        (mk_tactic_interpretation_5 f u_a u_b u_c u_d u_e e_f tc1)
       in
    let decr_depth_interp rng args =
      ...
      | (ps,uu____1195)::[] ->
          let uu____1212 =
            let uu____1213 =
              let uu____1214 = FStar_Tactics_Embedding.unembed_proofstate ps
                 in
    ...
    let incr_depth_interp rng args =
      ...
      | (ps,uu____1232)::[] ->
          let uu____1249 =
            let uu____1250 =
              let uu____1251 = FStar_Tactics_Embedding.unembed_proofstate ps
                 in
    ...
    let tracepoint_interp rng args =
      match args with
      | (ps,uu____1273)::[] ->
          ((let uu____1291 = FStar_Tactics_Embedding.unembed_proofstate ps
               in
            ...
            let uu____1328 =
              ...
              mktac0 "__intro_rec" FStar_Tactics_Basic.intro_rec
                (FStar_Syntax_Embeddings.embed_pair
                   ...
                   FStar_Reflection_Data.fstar_refl_binder
                   FStar_Reflection_Basic.embed_binder
                   FStar_Reflection_Data.fstar_refl_binder) uu____1329
               in
            let uu____1334 =
              let uu____1337 =
      ...
      FStar_Tactics_Basic.bind FStar_Tactics_Basic.get
        (fun proof_state  ->
           let tm =
             ...
             uu____1545 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let steps =
        ...
        (let tactic1 =
         ...
         (let uu____1915 =
          ...
          | (tactic2,uu____1929,uu____1930) ->
              let tau =
                unembed_tactic_0 FStar_Syntax_Embeddings.unembed_unit tactic2
                 in
                ...
                (match uu____2520 with
                 | (p',gs1) ->
                     ...
                     (match uu____2539 with
                      | (q',gs2) ->
                          let uu____2559 =
                            let uu____2560 = FStar_Syntax_Util.mk_imp p' q'
                               in
                    ...
                    fun g  ->
                      ...
                      | (n1,gs1) ->
                          ...
                          ((let uu____3402 = FStar_ST.op_Bang tacdbg  in
                            if uu____3402
                            then
                              let uu____3449 = FStar_Util.string_of_int n1
                                 in
                              let uu____3450 =
                           ...
                           (let gt' =
                              let uu____3453 =
                                let uu____3454 = FStar_Util.string_of_int n1
                                   in
...
let reify_tactic : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun a  ->
    let r =
      ...
      FStar_Syntax_Syntax.mk_Tm_uinst uu____3527 [FStar_Syntax_Syntax.U_zero]
       in
    let uu____3529 =
      let uu____3530 =
        let uu____3531 = FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_unit
           in
        let uu____3532 =
             ...
             let uu____3612 =
               FStar_List.existsML
                 (fun g  ->
                    ...
                    Prims.op_Negation uu____3616) gs
                in
             if uu____3612
             then
               FStar_Exn.raise
